[Mesh]
  file = out_PbTiO3_50nm_rT650K_tension2_screen34_restart284.e
  uniform_refine = 0
  #distribution = serial
[]
...
[GlobalParams]
   ...
   alpha1 = 0.02204 # (3.8 * (T - 785) * 10^5) C^{-2} nm^2 (T = 500 K)
   alpha11 = -0.073  #
   alpha111 = 0.26
   alpha12 = 0.75
   alpha112 = 0.61
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_PbTiO3_50nm_rT650K_tension2_screen34_restart32
    output_initial = true
