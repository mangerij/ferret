...
[Functions]
  [./stripe1]
    type = ParsedFunction
    value = 0.01*cos(0.10471975511965977*(x+y))+0.01  # 0.10471975511965977 = 2pi/(xmax-xmin)
  [../]
  [./stripe2]
    type = ParsedFunction
    value = -0.01*cos(0.10471975511965977*(x+y))+0.01
  [../]
[]
...
[Preconditioning]
  ...
  [./smp]
    ...
    petsc_options_value = '    160               1e-8      1e-8      1e-6          bjacobi       allreduce'
  [../]
[]
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_BTO_DW180_o100_dx0.5_T298K
