...
#ifndef INTERACTIONCARTLLGNORM_H
#define INTERACTIONCARTLLGNORM_H

#include "Kernel.h"

class InteractionCartLLGNorm;

template<>
InputParameters validParams<InteractionCartLLGNorm>();

class InteractionCartLLGNorm: public Kernel
{
public:

  InteractionCartLLGNorm(const InputParameters & parameters);
...
#endif //INTERACTIONCARTLLGNORM_H
