...
#ifndef AFMSUBLATTICEEXCHANGE_H
#define AFMSUBLATTICEEXCHANGE_H

#include "Kernel.h"

class AFMSublatticeExchange: public Kernel
{
public:

  AFMSublatticeExchange(const InputParameters & parameters);
