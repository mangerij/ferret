...
class ElectrostrictiveCouplingPDerivative: public Kernel
{
public:
  ElectrostrictiveCouplingPDerivative(const InputParameters & parameters);
...
#endif //ELECTROSTRICTIVECOUPLINGPDERIVATIVE_H
