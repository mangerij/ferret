...
#ifndef MASTEREXCHANGEUSLLGYI_H
#define MASTEREXCHANGEUSLLGYI_H

#include "Kernel.h"

class  MasterExchangeUSLLGYi: public Kernel
{
public:
  MasterExchangeUSLLGYi(const InputParameters & parameters);
