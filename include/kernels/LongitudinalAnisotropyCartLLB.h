...
#ifndef LONGITUDINALANISOTROPYCARTLLB_H
#define LONGITUDINALANISOTROPYCARTLLB_H

#include "Kernel.h"

class LongitudinalAnisotropyCartLLB;

template<>
InputParameters validParams<LongitudinalAnisotropyCartLLB>();

class LongitudinalAnisotropyCartLLB: public Kernel
{
public:
  LongitudinalAnisotropyCartLLB(const InputParameters & parameters);
...
#endif //LONGITUDINALANISOTROPYCARTLLB_H
