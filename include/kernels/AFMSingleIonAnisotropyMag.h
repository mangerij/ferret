...
#ifndef AFMSINGLEIONANISOTROPYMAG_H
#define AFMSINGLEIONANISOTROPYMAG_H

#include "Kernel.h"

class AFMSingleIonAnisotropyMag: public Kernel
{
public:
  AFMSingleIonAnisotropyMag(const InputParameters & parameters);
...
#endif //AFMSINGLEIONANISOTROPYMAG_H
