...
#ifndef AFMEEASYPLANEANISOTROPY_H
#define AFMEEASYPLANEANISOTROPY_H

#include "Kernel.h"

class AFMEasyPlaneAnisotropy: public Kernel
{
public:
  AFMEasyPlaneAnisotropy(const InputParameters & parameters);
...
#endif //AFMEASYPLANEANISOTROPY_H
