...
#ifndef DAMPINGSOFTCONSTRAINT_H
#define DAMPINGSOFTCONSTRAINT_H

#include "Kernel.h"

class DampingSoftConstraint;

template<>
InputParameters validParams<DampingSoftConstraint>();

class DampingSoftConstraint: public Kernel
{
public:

  DampingSoftConstraint(const InputParameters & parameters);
