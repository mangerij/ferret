...
#ifndef AFMSINGLEIONCUBICANISOTROPY_H
#define AFMSINGLEIONCUBICANISOTROPY_H

#include "Kernel.h"

class AFMSingleIonCubicAnisotropy: public Kernel
{
public:
  AFMSingleIonCubicAnisotropy(const InputParameters & parameters);
...
#endif //AFMSINGLEIONCUBICANISOTROPY_H
