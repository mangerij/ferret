...
#ifndef CONSTRAINEDEXCHANGELLG_H
#define CONSTRAINEDEXCHANGELLG_H

#include "Kernel.h"

class ConstrainedExchangeLLG;

template<>
InputParameters validParams<ConstrainedExchangeLLG>();

class  ConstrainedExchangeLLG: public Kernel
{
public:
  ConstrainedExchangeLLG(const InputParameters & parameters);
...
#endif //CONSTRAINEDEXCHANGELLG_H
