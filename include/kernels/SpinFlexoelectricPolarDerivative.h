...
#ifndef SPINFLEXOELECTRICPOLARDERIVATIVE_H
#define SPINFLEXOELECTRICPOLARDERIVATIVE_H

#include "Kernel.h"

class SpinFlexoelectricPolarDerivative;

template<>
InputParameters validParams<SpinFlexoelectricPolarDerivative>();

class SpinFlexoelectricPolarDerivative: public Kernel
{
public:

  SpinFlexoelectricPolarDerivative(const InputParameters & parameters);
...
#endif //SPINFLEXOELECTRICPOLARDERIVATIVE_H
