...
#ifndef LONGITUDINALINTERACTIONCARTLLB_H
#define LONGITUDINALINTERACTIONCARTLLB_H

#include "Kernel.h"

class LongitudinalInteractionCartLLB;

template<>
InputParameters validParams<LongitudinalInteractionCartLLB>();

class LongitudinalInteractionCartLLB: public Kernel
{
public:

  LongitudinalInteractionCartLLB(const InputParameters & parameters);
...
#endif //LONGITUDINALINTERACTIONCARTLLB_H
