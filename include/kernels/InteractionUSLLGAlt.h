...
#ifndef INTERACTIONUSLLGALT_H
#define INTERACTIONUSLLGALT_H

#include "Kernel.h"

class InteractionUSLLGAlt;

template<>
InputParameters validParams<InteractionUSLLGAlt>();

class InteractionUSLLGAlt: public Kernel
{
public:

  InteractionUSLLGAlt(const InputParameters & parameters);
