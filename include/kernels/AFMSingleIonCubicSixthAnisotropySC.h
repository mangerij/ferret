...
#ifndef AFMSINGLEIONCUBICSIXTHANISOTROPYSC_H
#define AFMSINGLEIONCUBICSIXTHANISOTROPYSC_H

#include "Kernel.h"

class AFMSingleIonCubicSixthAnisotropySC: public Kernel
{
public:
  AFMSingleIonCubicSixthAnisotropySC(const InputParameters & parameters);
...
#endif //AFMSINGLEIONCUBICSIXTHANISOTROPYSC_H
