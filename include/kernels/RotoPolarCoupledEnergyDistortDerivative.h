...
#ifndef ROTOPOLARCOUPLEDENERGYDISTORTDERIVATIVE_H
#define ROTOPOLARCOUPLEDENERGYDISTORTDERIVATIVE_H

#include "Kernel.h"

class RotoPolarCoupledEnergyDistortDerivative;

template<>
InputParameters validParams<RotoPolarCoupledEnergyDistortDerivative>();

class RotoPolarCoupledEnergyDistortDerivative: public Kernel
{
public:

  RotoPolarCoupledEnergyDistortDerivative(const InputParameters & parameters);
...
#endif //ROTOPOLARCOUPLEDENERGYDISTORTDERIVATIVE_H
