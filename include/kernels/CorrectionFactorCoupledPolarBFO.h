...
#ifndef CORRECTIONFACTORCOUPLEDPOLARBFO_H
#define CORRECTIONFACTORCOUPLEDPOLARBFO_H

#include "Kernel.h"

class CorrectionFactorCoupledPolarBFO;

template<>
InputParameters validParams<CorrectionFactorCoupledPolarBFO>();

class CorrectionFactorCoupledPolarBFO: public Kernel
{
public:

  CorrectionFactorCoupledPolarBFO(const InputParameters & parameters);
...
#endif //CORRECTIONFACTORCOUPLEDPOLARBFO_H
