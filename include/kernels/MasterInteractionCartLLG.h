...
#ifndef MASTERINTERACTIONCARTLLG_H
#define MASTERINTERACTIONCARTLLG_H

#include "Kernel.h"

class MasterInteractionCartLLG: public Kernel
{
public:

  MasterInteractionCartLLG(const InputParameters & parameters);
