...
#ifndef TRANSFORMED111KERNELOP6_H
#define TRANSFORMED111KERNELOP6_H

#include "Kernel.h"

class Transformed111KernelOp6;

template<>
InputParameters validParams<Transformed111KernelOp6>();

class Transformed111KernelOp6: public Kernel
{
public:

  Transformed111KernelOp6(const InputParameters & parameters);
...
protected:
  ...
  const VariableValue & _f_q3;
  const VariableValue & _f_q4;
  const VariableValue & _f_q5;
  const VariableValue & _J_q0q0;
  const VariableValue & _J_q1q1;
  const VariableValue & _J_q2q2;
  const VariableValue & _J_q3q3;
  const VariableValue & _J_q4q4;
  const VariableValue & _J_q5q5;
  ...
  const VariableValue & _J_q3q4;
  const VariableValue & _J_q3q5;
  const VariableValue & _J_q4q5;

};
#endif //TRANSFORMED111KERNELOP6_H
