...
#ifndef ELECTROSTRICTIVECOUPLINGDISPDERIVATIVE_H
#define ELECTROSTRICTIVECOUPLINGDISPDERIVATIVE_H
...
class ElectrostrictiveCouplingDispDerivative: public Kernel
{
public:

  ElectrostrictiveCouplingDispDerivative(const InputParameters & parameters);
...
#endif //ELECTROSTRICTIVECOUPLINGDISPDERIVATIVE_H
