...
#ifndef AFMSUBLATTICEDMI_H
#define AFMSUBLATTICEDMI_H

#include "Kernel.h"

class AFMSublatticeDMI: public Kernel
{
public:

  AFMSublatticeDMI(const InputParameters & parameters);
