...
#ifndef DAMPEDCONSTRAINEDANISOTROPYLLG_H
#define DAMPEDCONSTRAINEDANISOTROPYLLG_H

#include "Kernel.h"

class DampedConstrainedAnisotropyLLG;

template<>
InputParameters validParams<DampedConstrainedAnisotropyLLG>();

class  DampedConstrainedAnisotropyLLG: public Kernel
{
public:

  DampedConstrainedAnisotropyLLG(const InputParameters & parameters);
...
#endif //DAMPEDCONSTRAINEDANISOTROPYLLG_H
