...
#ifndef MASTEREXCHANGECARTLLG_H
#define MASTEREXCHANGECARTLLG_H

#include "Kernel.h"

class  MasterExchangeCartLLG: public Kernel
{
public:
  MasterExchangeCartLLG(const InputParameters & parameters);
