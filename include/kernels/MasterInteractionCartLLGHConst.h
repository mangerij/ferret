...
#ifndef MASTERINTERACTIONCARTLLGHCONST_H
#define MASTERINTERACTIONCARTLLGHCONST_H

#include "Kernel.h"

class MasterInteractionCartLLGHConst: public Kernel
{
public:

  MasterInteractionCartLLGHConst(const InputParameters & parameters);
