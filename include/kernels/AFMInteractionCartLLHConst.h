...
#ifndef AFMINTERACTIONCARTLLHCONST_H
#define AFMINTERACTIONCARTLLHCONST_H

#include "Kernel.h"

class AFMInteractionCartLLHConst: public Kernel
{
public:

  AFMInteractionCartLLHConst(const InputParameters & parameters);
...
#endif //AFMINTERACTIONCARTLLHCONST_H
