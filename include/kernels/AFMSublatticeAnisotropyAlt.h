...
#ifndef AFMSUBLATTICEANISOTROPYALT_H
#define AFMSUBLATTICEANISOTROPYALT_H

#include "Kernel.h"

class AFMSublatticeAnisotropyAlt: public Kernel
{
public:
  AFMSublatticeAnisotropyAlt(const InputParameters & parameters);
...
#endif //AFMSUBLATTICEANISOTROPYALT_H
