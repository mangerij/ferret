...
#ifndef AFMSINGLEIONANISOTROPYALT_H
#define AFMSINGLEIONANISOTROPYALT_H

#include "Kernel.h"

class AFMSingleIonAnisotropyAlt: public Kernel
{
public:
  AFMSingleIonAnisotropyAlt(const InputParameters & parameters);
...
#endif //AFMSINGLEIONANISOTROPYALT_H
