...
#ifndef MASTERLONGITUDINALLLB_H
#define MASTERLONGITUDINALLLB_H

#include "Kernel.h"

class MasterLongitudinalLLB: public Kernel
{
public:

  MasterLongitudinalLLB(const InputParameters & parameters);
