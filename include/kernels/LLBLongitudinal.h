...
#ifndef LLBLONGITUDINAL_H
#define LLBLONGITUDINAL_H

#include "Kernel.h"

class LLBLongitudinal;

template<>
InputParameters validParams<LLBLongitudinal>();

class  LLBLongitudinal: public Kernel
{
public:
  LLBLongitudinal(const InputParameters & parameters);
