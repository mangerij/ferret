...
#ifndef INTERACTIONCONSTRAINEDLLG_H
#define INTERACTIONCONSTRAINEDLLG_H

#include "Kernel.h"

class InteractionConstrainedLLG;

template<>
InputParameters validParams<InteractionConstrainedLLG>();

class InteractionConstrainedLLG: public Kernel
{
public:

  InteractionConstrainedLLG(const InputParameters & parameters);
...
#endif //INTERACTIONCONSTRAINEDLLG_H
