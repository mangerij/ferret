...
#ifndef CORRECTIONFACTORCOUPLEDDISTORTBFO_H
#define CORRECTIONFACTORCOUPLEDDISTORTBFO_H

#include "Kernel.h"

class CorrectionFactorCoupledDistortBFO;

template<>
InputParameters validParams<CorrectionFactorCoupledDistortBFO>();

class CorrectionFactorCoupledDistortBFO: public Kernel
{
public:

  CorrectionFactorCoupledDistortBFO(const InputParameters & parameters);
...
#endif //CORRECTIONFACTORCOUPLEDDISTORTBFO_H
