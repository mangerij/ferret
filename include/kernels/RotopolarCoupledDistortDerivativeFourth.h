...
#ifndef ROTOPOLARCOUPLEDDISTORTDERIVATIVEFOURTH_H
#define ROTOPOLARCOUPLEDDISTORTDERIVATIVEFOURTH_H

#include "Kernel.h"

class RotopolarCoupledDistortDerivativeFourth;

template<>
InputParameters validParams<RotopolarCoupledDistortDerivativeFourth>();

class RotopolarCoupledDistortDerivativeFourth: public Kernel
{
public:

  RotopolarCoupledDistortDerivativeFourth(const InputParameters & parameters);
...
#endif //ROTOPOLARCOUPLEDDISTORTDERIVATIVEFOURTH_H
