...
#ifndef TIMEMAGCONSTRAINTLLG_H
#define TIMEMAGCONSTRAINTLLG_H

#include "TimeKernel.h"
#include "libmesh/quadrature.h"
#include "Assembly.h"

class TimeMagConstraintLLG;

template<>
InputParameters validParams<TimeMagConstraintLLG>();

class TimeMagConstraintLLG : public TimeKernel
{
public:
  TimeMagConstraintLLG(const InputParameters & parameters);
