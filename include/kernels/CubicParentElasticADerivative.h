...
#ifndef CUBICPARENTELASTICADERIVATIVE_H
#define CUBICPARENTELASTICADERIVATIVE_H

#include "Kernel.h"
#include "RankFourTensor.h"
#include "RankTwoTensor.h"

class CubicParentElasticADerivative: public Kernel
{
public:
  CubicParentElasticADerivative(const InputParameters & parameters);
...
protected:
  ...
  RankTwoTensor dEigenstrain_dA(unsigned int i) const;
...
#endif //CUBICPARENTELASTICADERIVATIVE_H
