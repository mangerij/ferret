...
#ifndef AFMSUBLATTICEANISOTROPYALTTIGHTLYCOUPLED_H
#define AFMSUBLATTICEANISOTROPYALTTIGHTLYCOUPLED_H

#include "Kernel.h"

class AFMSublatticeAnisotropyAltTightlyCoupled: public Kernel
{
public:
  AFMSublatticeAnisotropyAltTightlyCoupled(const InputParameters & parameters);
...
#endif //AFMSUBLATTICEANISOTROPYALTTIGHTLYCOUPLED_H
