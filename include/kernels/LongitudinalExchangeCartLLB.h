...
#ifndef LONGITUDINALEXCHANGECARTLLB_H
#define LONGITUDINALEXCHANGECARTLLB_H

#include "Kernel.h"

class LongitudinalExchangeCartLLB;

template<>
InputParameters validParams<LongitudinalExchangeCartLLB>();

class  LongitudinalExchangeCartLLB: public Kernel
{
public:
  LongitudinalExchangeCartLLB(const InputParameters & parameters);
...
#endif //LONGITUDINALEXCHANGECARTLLB_H
