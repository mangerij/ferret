...
#ifndef MASTERANISOTROPYCARTLLG_H
#define MASTERANISOTROPYCARTLLG_H

#include "Kernel.h"

class MasterAnisotropyCartLLG: public Kernel
{
public:
  MasterAnisotropyCartLLG(const InputParameters & parameters);
