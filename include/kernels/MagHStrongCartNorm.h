...
#ifndef MAGHSTRONGCARTNORM_H
#define MAGHSTRONGCARTNORM_H
...
class MagHStrongCartNorm: public Kernel
{
public:

  MagHStrongCartNorm(const InputParameters & parameters);
