...
#ifndef AFMSUBLATTICEANISOTROPYCARTLL_H
#define AFMSUBLATTICEANISOTROPYCARTLL_H

#include "Kernel.h"

class AFMSublatticeAnisotropyCartLL: public Kernel
{
public:
  AFMSublatticeAnisotropyCartLL(const InputParameters & parameters);
...
#endif //AFMSUBLATTICEANISOTROPYCARTLL_H
