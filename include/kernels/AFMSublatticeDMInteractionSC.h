...
#ifndef AFMSUBLATTICEDMINTERACTIONSC_H
#define AFMSUBLATTICEDMINTERACTIONSC_H

#include "Kernel.h"

class AFMSublatticeDMInteractionSC: public Kernel
{
public:

  AFMSublatticeDMInteractionSC(const InputParameters & parameters);
...
#endif //AFMSUBLATTICEDMINTERACTIONSC_H
