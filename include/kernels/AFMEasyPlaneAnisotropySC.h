...
#ifndef AFMEEASYPLANEANISOTROPYSC_H
#define AFMEEASYPLANEANISOTROPYSC_H

#include "Kernel.h"

class AFMEasyPlaneAnisotropySC: public Kernel
{
public:
  AFMEasyPlaneAnisotropySC(const InputParameters & parameters);
...
#endif //AFMEASYPLANEANISOTROPYSC_H
