...
#ifndef BULKZLSPINTORQUECART_H
#define BULKZLSPINTORQUECART_H
...
protected:
  ...
  const VariableValue & _j_x;
  const VariableValue & _j_y;
  const VariableValue & _j_z;
  const MaterialProperty<Real> & _muB;
