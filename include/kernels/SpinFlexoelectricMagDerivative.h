...
#ifndef SPINFLEXOELECTRICMAGDERIVATIVE_H
#define SPINFLEXOELECTRICMAGDERIVATIVE_H

#include "Kernel.h"

class SpinFlexoelectricMagDerivative;

template<>
InputParameters validParams<SpinFlexoelectricMagDerivative>();

class SpinFlexoelectricMagDerivative: public Kernel
{
public:
  SpinFlexoelectricMagDerivative(const InputParameters & parameters);
...
#endif //SPINFLEXOELECTRICMAGDERIVATIVE_H
