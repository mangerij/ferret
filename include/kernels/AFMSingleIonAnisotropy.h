...
#ifndef AFMSINGLEIONANISOTROPY_H
#define AFMSINGLEIONANISOTROPY_H

#include "Kernel.h"

class AFMSingleIonAnisotropy: public Kernel
{
public:
  AFMSingleIonAnisotropy(const InputParameters & parameters);
...
#endif //AFMSINGLEIONANISOTROPY_H
