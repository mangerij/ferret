...
#ifndef CONSTRAINEDANISOTROPYLLG_H
#define CONSTRAINEDANISOTROPYLLG_H

#include "Kernel.h"

class ConstrainedAnisotropyLLG;

template<>
InputParameters validParams<ConstrainedAnisotropyLLG>();

class  ConstrainedAnisotropyLLG: public Kernel
{
public:

  ConstrainedAnisotropyLLG(const InputParameters & parameters);
...
#endif //CONSTRAINEDANISOTROPYLLG_H
