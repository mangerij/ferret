...
#ifndef DZYALOSHINSKIIDISTORTDERIVATIVE_H
#define DZYALOSHINSKIIDISTORTDERIVATIVE_H

#include "Kernel.h"

class DzyaloshinskiiDistortDerivative;

template<>
InputParameters validParams<DzyaloshinskiiDistortDerivative>();

class DzyaloshinskiiDistortDerivative: public Kernel
{
public:

  DzyaloshinskiiDistortDerivative(const InputParameters & parameters);
...
#endif //DZYALOSHINSKIIDISTORTDERIVATIVE_H
