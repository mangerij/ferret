...
#ifndef AFMHOMOGENEOUSASYMSPINCURRENTENERGY_H
#define AFMHOMOGENEOUSASYMSPINCURRENTENERGY_H

#include "ElementIntegralPostprocessor.h"

class AFMHomogeneousAsymSpinCurrentEnergy : public ElementIntegralPostprocessor
{
public:
  AFMHomogeneousAsymSpinCurrentEnergy(const InputParameters & parameters);
