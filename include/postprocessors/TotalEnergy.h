...
protected:
  //const PostprocessorValue & _bulk_energy, & _wall_energy, & _electrostatic_energy;
  const PostprocessorValue & _bulk_energy, & _wall_energy, & _electrostatic_energy, & _elastic_energy;
};
