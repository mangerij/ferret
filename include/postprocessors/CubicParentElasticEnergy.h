...
#ifndef CUBICPARENTELASTICENERGY_H
#define CUBICPARENTELASTICENERGY_H

#include "ElementIntegralPostprocessor.h"

class CubicParentElasticEnergy : public ElementIntegralPostprocessor
{
public:
  CubicParentElasticEnergy(const InputParameters & parameters);
