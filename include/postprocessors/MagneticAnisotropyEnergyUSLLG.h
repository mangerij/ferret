...
#ifndef MAGNETICANISOTROPYENERGYUSLLG_H
#define MAGNETICANISOTROPYENERGYUSLLG_H

#include "ElementIntegralPostprocessor.h"

class MagneticAnisotropyEnergyUSLLG : public ElementIntegralPostprocessor
{
public:
  MagneticAnisotropyEnergyUSLLG(const InputParameters & parameters);
