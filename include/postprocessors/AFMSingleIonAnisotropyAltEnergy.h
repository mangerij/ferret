...
#ifndef AFMSINGLEIONANISOTROPYALTENERGY_H
#define AFMSINGLEIONANISOTROPYALTENERGY_H

#include "ElementIntegralPostprocessor.h"

class AFMSingleIonAnisotropyAltEnergy : public ElementIntegralPostprocessor
{
public:
  AFMSingleIonAnisotropyAltEnergy(const InputParameters & parameters);
