 ...
 */
template <class T>
class LocalConservedNormalNoiseVeneer : public T
{
public:
  LocalConservedNormalNoiseVeneer(const InputParameters & parameters);
...
template <class T>
LocalConservedNormalNoiseVeneer<T>::LocalConservedNormalNoiseVeneer(const InputParameters & parameters)
...
template <class T>
Real
LocalConservedNormalNoiseVeneer<T>::getQpRandom()
{
  // Box-Muller
  if (_phase == 0)
  {
