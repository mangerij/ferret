...
#include "LocalConservedNormalNoiseVeneer.h"
 ...
 */
class LocalConservedNormalNoise : public LocalConservedNormalNoiseVeneer<LocalConservedNoiseBase>
{
public:
  static InputParameters validParams();

  LocalConservedNormalNoise(const InputParameters & parameters)
    : LocalConservedNormalNoiseVeneer<LocalConservedNoiseBase>(parameters)
  {
  }
};
