 ...
 */
class LocalConservedNoiseInterface : public ElementUserObject
{
public:
  LocalConservedNoiseInterface(const InputParameters & parameters);
  virtual ~LocalConservedNoiseInterface() {}
