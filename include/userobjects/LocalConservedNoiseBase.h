...
#include "LocalConservedNoiseInterface.h"
 ...
 */
class LocalConservedNoiseBase : public LocalConservedNoiseInterface
{
public:
  static InputParameters validParams();

  LocalConservedNoiseBase(const InputParameters & parameters);

  virtual ~LocalConservedNoiseBase() {}
