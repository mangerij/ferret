# This test stretches a cube vertically. XY-tractions on the top and the 
# bottom (as well as ALL tractions on the vertical boundaries) are zero,
# hence, free in XY, or laterally.
[Mesh]#Comment
  file = brick.e
...
[Output]
  file_base = brick_zstretched_xyfree
  interval = 1
  output_initial = true
