...
[Executioner]
  ...
  type = Steady
  petsc_options = '-snes_mf_operator -snes_view -snes_monitor -snes_converged_reason -ksp_monitor -ksp_converged_reason -pc_svd_monitor -options_table -options_left'
