...
[Mesh]
  file = exodus_thinfilm_test_075_20_10_10.e
  #uniform_refine = 1
[]
...
[GlobalParams]
  ...
  prefactor = 0.003 #negative = tension, positive = compression
[]
...
[Executioner]
  type = Transient
    ...
    dt = 2.4 #seems that BTO needs larger time steps?
    #iteration_window = 3
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = outBTO_thinfilm_075_20_10_10_G1_c003_STO
