[Mesh]
  ...
  uniform_refine=1 #would need to refine a few times to get the right values...
[]
...
[GlobalParams]
   len_scale=1e-7 #simulation convergence is highly sensitive to parameter
   #len_scale=1.0
   alpha1=-1.7252e14 # 3.8(T-479)*10^5 C^{-2}m^2
   alpha11=-7.3e25
   alpha111=2.6e26
   alpha12=7.5e38
   alpha112=6.1e38
   alpha123=-3.7e39
   G110=6e6 #simulation convergence is highly sensitive to parameter
   #G110=0.0
   G11/G110=0.6
   G12/G110=0.0
   G44/G110=0.3
   G44P/G110=0.3
   permittivity=8.85e-18
   #permittivity=1.0
   polar_x=polar_x
   polar_y=polar_y
   polar_z=polar_z
...
[Executioner]
 ...
 # petsc_options='-snes_monitor -snes_converged_reason -ksp_monitor -ksp_converged_reason'
  ...
  petsc_options_value='1000            1e-10       gmres       1e-12      jacobi       basic                1e-50'
...
[Outputs]
  file_base = out_PbTiO3_differentLen-2
  output_initial = true
