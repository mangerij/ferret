...
[BCs]
  ...
  [../]
   [./potential_ext_upz]
    ...
    variable = potential_ext
    boundary = '1'
    value = 0.0 #should carry 10^{-18} from pow(len_scale,2)
    #implicit=false
  [../]
  [./potential_ext_downz]
    type = DirichletBC
...
[Executioner]
 ...
 # petsc_options='-snes_monitor -snes_converged_reason -ksp_monitor -ksp_converged_reason'
  ...
  petsc_options_value='1000            1e-6        gmres       1e-8      jacobi       basic                1e-50'
...
[Outputs]
  file_base = out_PbTiO3_bulk_len-9_icConst_dt1e17_n3500_actual100
  output_initial = true
