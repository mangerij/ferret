...
[GlobalParams]
   ...
   #permittivity = 7.5 * e_0 #this is background due to high frequency polar
   #                          modes and electrons; see PRB 89, 174111 (2014)
   polar_x = polar_x
   polar_y = polar_y
   polar_z = polar_z
  ...
  prefactor = -0.002 #negative = tension, positive = compression
[]
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_BTO_thinfilm_tens05_nat
