[Mesh]
  file = out_PbTiO3_bulk_len-9_icConst111_n4500_0field_1wall_PE_20.e
  uniform_refine=0
  distribution=serial
[]
...
#active='potential_int potential_ext'
  [./polar_x]
    ...
    initial_from_file_timestep = 3254
  [../]
  [./polar_y]
    #scaling=1e14
    order = FIRST
...
print_perf_log = true
  ...
  [./out]
    type = Exodus
    file_base = Restart-out_PbTiO3_bulk_len-9_icConst111_n3254_0field_1wall_20
    output_initial = true
