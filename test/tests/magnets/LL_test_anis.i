...
[Materials]
  [./constants] # Constants used in other material properties
    ...
    prop_names = ' alpha    Ae    Ms g0 mu0 alpha_long nx ny nz K1 K2'
    prop_values = '0.2    0.013  1.0 0.1761 1256.1 500 0  0  1  50.0 0'
  [../]
[]
