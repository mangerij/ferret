...
args = 'TC=${TC};um=${um};l0=${l0};Lx=${Lx};tf=${tf};nx=${nx};ny=${ny}'
args_polar = '${args};lam=${lam};P_seed=${P_seed};Px_seed=${Px_seed};eps_r=${eps_r};dt_polar=${dt_polar}'
args_mech  = '${args}'
...
[MultiApps]
  [polar]
    ...
    input_files = PTO_2D_E_multi_polar.i
    cli_args = '${args_polar}'
  ...
  [mech]
    type = TransientMultiApp
    input_files = PTO_2D_E_multi_mech.i
    cli_args = '${args_mech}'
    execute_on = TIMESTEP_END
