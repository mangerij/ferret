...
InputParameters MieElecFieldReals::validParams()
...
MieElecFieldReals::MieElecFieldReals(const InputParameters & parameters) :
...
Real
MieElecFieldReals::computeValue()
{
#ifdef FERRET_HAVE_BOOST_MATH_SPECIAL_FUNCTIONS
