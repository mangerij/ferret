...
InputParameters validParams<ConvertField>()
{
  ...
  params.addRequiredCoupledVar("polar_z_red", "The reduced field");
  ...
  params.addRequiredCoupledVar("antiferrodis_A_z_red", "The reduced field");
  params.addRequiredCoupledVar("disp_x_red", "The reduced field");
  params.addRequiredCoupledVar("disp_y_red", "The reduced field");
  params.addRequiredCoupledVar("disp_z_red", "The reduced field");
  params.addRequiredCoupledVar("strain_xx_red", "The reduced field");
  params.addRequiredCoupledVar("strain_yy_red", "The reduced field");
  params.addRequiredCoupledVar("strain_zz_red", "The reduced field");
  params.addRequiredCoupledVar("strain_xy_red", "The reduced field");
  params.addRequiredCoupledVar("strain_xz_red", "The reduced field");
  params.addRequiredCoupledVar("strain_yz_red", "The reduced field");
