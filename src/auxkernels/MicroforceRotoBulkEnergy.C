...
template<>
InputParameters validParams<MicroforceRotoBulkEnergy>()
{
...
MicroforceRotoBulkEnergy::computeValue()
{
  if (_component == 0)
  {
   return (2*_beta1[_qp]*_antiferrodis_A_x[_qp] + 4*_beta11[_qp]*Utility::pow<3>(_antiferrodis_A_x[_qp]) + 6*_beta111[_qp]*Utility::pow<5>(_antiferrodis_A_x[_qp]) + 8*_beta1111[_qp]*Utility::pow<7>(_antiferrodis_A_x[_qp]) + 
  ...
  {
    return (2*_beta1[_qp]*_antiferrodis_A_y[_qp] + 4*_beta11[_qp]*Utility::pow<3>(_antiferrodis_A_y[_qp]) + 6*_beta111[_qp]*Utility::pow<5>(_antiferrodis_A_y[_qp]) + 8*_beta1111[_qp]*Utility::pow<7>(_antiferrodis_A_y[_qp]) + 
  ...
  {
    return (2*_beta1[_qp]*_antiferrodis_A_z[_qp] + 2*_beta123[_qp]*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_antiferrodis_A_y[_qp])*_antiferrodis_A_z[_qp] + 4*_beta11[_qp]*Utility::pow<3>(_antiferrodis_A_z[_qp]) + 
