...
ComputeRotatedPiezostrictiveTensorBase::ComputeRotatedPiezostrictiveTensorBase(const InputParameters & parameters) :
    ComputePiezostrictiveTensorBase(parameters),
