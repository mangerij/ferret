...
#include "AFMSublatticeDMInteractionEnergy.h"

registerMooseObject("FerretApp", AFMSublatticeDMInteractionEnergy);

InputParameters AFMSublatticeDMInteractionEnergy::validParams()
{
...
AFMSublatticeDMInteractionEnergy::AFMSublatticeDMInteractionEnergy(const InputParameters & parameters) :
...
Real
AFMSublatticeDMInteractionEnergy::computeQpIntegral()
{
