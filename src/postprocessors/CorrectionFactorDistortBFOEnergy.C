...
{
  return (_f1[_qp]*(-3*Utility::pow<4>(_antiferrodis_A_x[_qp]) - 3*Utility::pow<4>(_antiferrodis_A_y[_qp]) - 3*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp] + Utility::pow<2>(_antiferrodis_A_z[_qp]) - 3*Utility::pow<4>(_antiferrodis_A_z[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp])*(1 + 3*Utility::pow<2>(_antiferrodis_A_z[_qp])) + Utility::pow<2>(_antiferrodis_A_x[_qp])*(1 + 3*Utility::pow<2>(_antiferrodis_A_y[_qp]) + 3*Utility::pow<2>(_antiferrodis_A_z[_qp]))));
}
