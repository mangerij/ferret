...
InputParameters validParams<SumNinePostprocessors>()
{
  ...
  params.addRequiredParam<PostprocessorName>("var8", "name of ninth postprocessor");
  return params;
}

SumNinePostprocessors::SumNinePostprocessors(const InputParameters & parameters) :
...
SumNinePostprocessors::~SumNinePostprocessors(){
}

void
SumNinePostprocessors::initialize(){
}

void
SumNinePostprocessors::execute(){
}

Real
SumNinePostprocessors::getValue()
{
