...
#include "SDBulkEnergyEighth.h"
#include "libmesh/utility.h"

registerMooseObject("FerretApp", SDBulkEnergyEighth);

InputParameters SDBulkEnergyEighth::validParams()
{
...
SDBulkEnergyEighth::SDBulkEnergyEighth(const InputParameters & parameters) :
...
Real
SDBulkEnergyEighth::computeQpIntegral()
{
