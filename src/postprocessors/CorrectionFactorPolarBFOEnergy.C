...
{
  return (_f0[_qp]*(-Utility::pow<4>(_polar_x[_qp]) + _polar_x[_qp]*_polar_x[_qp]*_polar_y[_qp]*_polar_y[_qp] - Utility::pow<4>(_polar_y[_qp]) + _polar_x[_qp]*_polar_x[_qp]*_polar_z[_qp]*_polar_z[_qp] + _polar_y[_qp]*_polar_y[_qp]*_polar_z[_qp]*_polar_z[_qp] - Utility::pow<4>(_polar_z[_qp])));
}
