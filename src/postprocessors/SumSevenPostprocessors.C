...
SumSevenPostprocessors::SumSevenPostprocessors(const InputParameters & parameters) :
...
SumSevenPostprocessors::~SumSevenPostprocessors(){
}

void
SumSevenPostprocessors::initialize(){
}

void
SumSevenPostprocessors::execute(){
}

Real
SumSevenPostprocessors::getValue()
{
