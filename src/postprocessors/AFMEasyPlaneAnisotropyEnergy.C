...
registerMooseObject("FerretApp", AFMEasyPlaneAnisotropyEnergy);

InputParameters AFMEasyPlaneAnisotropyEnergy::validParams()
{
...
AFMEasyPlaneAnisotropyEnergy::AFMEasyPlaneAnisotropyEnergy(const InputParameters & parameters) :
...
Real
AFMEasyPlaneAnisotropyEnergy::computeQpIntegral()
{
