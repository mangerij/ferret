...
#include "AFMSublatticeSuperexchangeEnergy.h"

registerMooseObject("FerretApp", AFMSublatticeSuperexchangeEnergy);

InputParameters AFMSublatticeSuperexchangeEnergy::validParams()
{
...
AFMSublatticeSuperexchangeEnergy::AFMSublatticeSuperexchangeEnergy(const InputParameters & parameters) :
