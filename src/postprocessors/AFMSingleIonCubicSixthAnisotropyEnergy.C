...
#include "AFMSingleIonCubicSixthAnisotropyEnergy.h"

registerMooseObject("FerretApp", AFMSingleIonCubicSixthAnisotropyEnergy);

InputParameters AFMSingleIonCubicSixthAnisotropyEnergy::validParams()
{
...
AFMSingleIonCubicSixthAnisotropyEnergy::AFMSingleIonCubicSixthAnisotropyEnergy(const InputParameters & parameters) :
