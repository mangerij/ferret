...
TotalEnergyBFO::TotalEnergyBFO(const InputParameters & parameters) :
...
TotalEnergyBFO::~TotalEnergyBFO(){
}

void
TotalEnergyBFO::initialize(){
}

void
TotalEnergyBFO::execute(){
}

Real
TotalEnergyBFO::getValue()
{
  return _FbP + _FbA + _FgP + _FgA + _FcPA + _FcPu + _FcAu + _Felu;
}
