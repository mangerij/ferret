...
#include "MasterMagneticAnisotropyEnergy.h"
#include "libmesh/utility.h"

registerMooseObject("FerretApp", MasterMagneticAnisotropyEnergy);

InputParameters MasterMagneticAnisotropyEnergy::validParams()
{
...
MasterMagneticAnisotropyEnergy::MasterMagneticAnisotropyEnergy(const InputParameters & parameters) :
