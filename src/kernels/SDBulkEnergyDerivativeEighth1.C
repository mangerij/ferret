...
#include "SDBulkEnergyDerivativeEighth1.h"
#include "libmesh/utility.h"

registerMooseObject("FerretApp", SDBulkEnergyDerivativeEighth1);

template<>
InputParameters validParams<SDBulkEnergyDerivativeEighth1>()
{
...
SDBulkEnergyDerivativeEighth1::SDBulkEnergyDerivativeEighth1(const InputParameters & parameters)
  :Kernel(parameters),
...
Real
SDBulkEnergyDerivativeEighth1::computeQpResidual()
{
  if (_component == 0)
  {
...
Real
SDBulkEnergyDerivativeEighth1::computeQpJacobian()
{
  if (_component == 0)
  {
...
Real
SDBulkEnergyDerivativeEighth1::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
