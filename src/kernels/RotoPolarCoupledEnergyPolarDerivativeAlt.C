...
RotoPolarCoupledEnergyPolarDerivativeAlt::computeQpResidual()
{
  ...
  {
    return _test[_i][_qp] * (2*Utility::pow<2>(_antiferrodis_A_z[_qp])*_polar_z[_qp]*_t1111 + 2*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*_polar_z[_qp]*_t1122 + (_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp] + _antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_y[_qp])*_t1212 + 2*Utility::pow<4>(_antiferrodis_A_z[_qp])*_polar_z[_qp]*_t24111111 + 2*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*Utility::pow<2>(_antiferrodis_A_z[_qp])*_polar_z[_qp]*_t24111122 + 
   2*(Utility::pow<4>(_antiferrodis_A_x[_qp]) + Utility::pow<4>(_antiferrodis_A_y[_qp]))*_polar_z[_qp]*_t24112222 + 2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_antiferrodis_A_y[_qp])*_polar_z[_qp]*_t24112233 + (Utility::pow<3>(_antiferrodis_A_x[_qp])*_antiferrodis_A_z[_qp]*_polar_x[_qp] + Utility::pow<3>(_antiferrodis_A_y[_qp])*_antiferrodis_A_z[_qp]*_polar_y[_qp] + Utility::pow<3>(_antiferrodis_A_z[_qp])*(_antiferrodis_A_x[_qp]*_polar_x[_qp] + _antiferrodis_A_y[_qp]*_polar_y[_qp]))*_t24121112 + 
   ...
   4*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*Utility::pow<3>(_polar_z[_qp])*_t42111122 + (_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*Utility::pow<3>(_polar_x[_qp]) + _antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*Utility::pow<3>(_polar_y[_qp]) + 3*(_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp] + _antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_y[_qp])*Utility::pow<2>(_polar_z[_qp]))*_t42111212 + 
   (2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_polar_x[_qp])*_polar_z[_qp] + 2*Utility::pow<2>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_y[_qp])*_polar_z[_qp] + 2*Utility::pow<2>(_antiferrodis_A_z[_qp])*(Utility::pow<2>(_polar_x[_qp]) + Utility::pow<2>(_polar_y[_qp]))*_polar_z[_qp])*_t42112211 + (2*Utility::pow<2>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_x[_qp])*_polar_z[_qp] + 2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_polar_y[_qp])*_polar_z[_qp])*_t42112233 + 
   ...
   6*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<5>(_polar_z[_qp])*_t6211111111 + 6*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*Utility::pow<5>(_polar_z[_qp])*_t6211111122);
  }
  else
    return 0.0;
}
...
RotoPolarCoupledEnergyPolarDerivativeAlt::computeQpJacobian()
{
  if (_component == 0)
  {
    return _test[_i][_qp] * _phi[_j][_qp] * (2*Utility::pow<2>(_antiferrodis_A_x[_qp])*_t1111 + 2*(Utility::pow<2>(_antiferrodis_A_y[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*_t1122 + 2*Utility::pow<4>(_antiferrodis_A_x[_qp])*_t24111111 + 2*Utility::pow<2>(_antiferrodis_A_x[_qp])*(Utility::pow<2>(_antiferrodis_A_y[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*_t24111122 + 2*(Utility::pow<4>(_antiferrodis_A_y[_qp]) + Utility::pow<4>(_antiferrodis_A_z[_qp]))*_t24112222 + 
   2*Utility::pow<2>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_antiferrodis_A_z[_qp])*_t24112233 + 2*Utility::pow<6>(_antiferrodis_A_x[_qp])*_t2611111111 + 2*(Utility::pow<6>(_antiferrodis_A_y[_qp]) + Utility::pow<6>(_antiferrodis_A_z[_qp]))*_t2611222222 + 12*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_polar_x[_qp])*_t42111111 + 12*(Utility::pow<2>(_antiferrodis_A_y[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*Utility::pow<2>(_polar_x[_qp])*_t42111122 + 
   6*_polar_x[_qp]*(_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_polar_y[_qp] + _antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_z[_qp])*_t42111212 + (2*Utility::pow<2>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_y[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<2>(_polar_z[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_x[_qp])*(Utility::pow<2>(_polar_y[_qp]) + Utility::pow<2>(_polar_z[_qp])))*_t42112211 + 
   ...
   30*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<4>(_polar_x[_qp])*_t6211111111 + 30*(Utility::pow<2>(_antiferrodis_A_y[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*Utility::pow<4>(_polar_x[_qp])*_t6211111122);
  }
  else if (_component == 1)
  {
    return _test[_i][_qp] * _phi[_j][_qp] * (2*Utility::pow<2>(_antiferrodis_A_y[_qp])*_t1111 + 2*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*_t1122 + 2*Utility::pow<4>(_antiferrodis_A_y[_qp])*_t24111111 + 2*Utility::pow<2>(_antiferrodis_A_y[_qp])*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*_t24111122 + 2*(Utility::pow<4>(_antiferrodis_A_x[_qp]) + Utility::pow<4>(_antiferrodis_A_z[_qp]))*_t24112222 + 
   2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_antiferrodis_A_z[_qp])*_t24112233 + 2*Utility::pow<6>(_antiferrodis_A_y[_qp])*_t2611111111 + 2*(Utility::pow<6>(_antiferrodis_A_x[_qp]) + Utility::pow<6>(_antiferrodis_A_z[_qp]))*_t2611222222 + 12*Utility::pow<2>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_y[_qp])*_t42111111 + 12*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*Utility::pow<2>(_polar_y[_qp])*_t42111122 + 
   6*_polar_y[_qp]*(_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_polar_x[_qp] + _antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_z[_qp])*_t42111212 + (2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_polar_x[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<2>(_polar_z[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_y[_qp])*(Utility::pow<2>(_polar_x[_qp]) + Utility::pow<2>(_polar_z[_qp])))*_t42112211 + 
   (2*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<2>(_polar_x[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_polar_z[_qp]))*_t42112233 + 2*_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_z[_qp]*_t42123312 + 12*Utility::pow<4>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_y[_qp])*_t4411111111 + 2*(Utility::pow<4>(_antiferrodis_A_x[_qp]) + Utility::pow<4>(_antiferrodis_A_z[_qp]))*_t4411112222 + 
   30*Utility::pow<2>(_antiferrodis_A_y[_qp])*Utility::pow<4>(_polar_y[_qp])*_t6211111111 + 30*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*Utility::pow<4>(_polar_y[_qp])*_t6211111122);
  }
  else if (_component == 2)
  {
    return _test[_i][_qp] * _phi[_j][_qp] * (2*Utility::pow<2>(_antiferrodis_A_z[_qp])*_t1111 + 2*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*_t1122 + 2*Utility::pow<4>(_antiferrodis_A_z[_qp])*_t24111111 + 2*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*Utility::pow<2>(_antiferrodis_A_z[_qp])*_t24111122 + 2*(Utility::pow<4>(_antiferrodis_A_x[_qp]) + Utility::pow<4>(_antiferrodis_A_y[_qp]))*_t24112222 + 
   2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_antiferrodis_A_y[_qp])*_t24112233 + 2*Utility::pow<6>(_antiferrodis_A_z[_qp])*_t2611111111 + 2*(Utility::pow<6>(_antiferrodis_A_x[_qp]) + Utility::pow<6>(_antiferrodis_A_y[_qp]))*_t2611222222 + 12*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<2>(_polar_z[_qp])*_t42111111 + 12*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*Utility::pow<2>(_polar_z[_qp])*_t42111122 + 
   6*(_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp] + _antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_y[_qp])*_polar_z[_qp]*_t42111212 + (2*Utility::pow<2>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_polar_x[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_y[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_z[_qp])*(Utility::pow<2>(_polar_x[_qp]) + Utility::pow<2>(_polar_y[_qp])))*_t42112211 + 
   ...
   30*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<4>(_polar_z[_qp])*_t6211111111 + 30*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_y[_qp]))*Utility::pow<4>(_polar_z[_qp])*_t6211111122);
  }
  else
    return 0.0;
}
...
RotoPolarCoupledEnergyPolarDerivativeAlt::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
    ...
    {
      return _test[_i][_qp] * _phi[_j][_qp] *  (_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_t1212 + (Utility::pow<3>(_antiferrodis_A_x[_qp])*_antiferrodis_A_y[_qp] + _antiferrodis_A_x[_qp]*Utility::pow<3>(_antiferrodis_A_y[_qp]))*_t24121112 + _antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*Utility::pow<2>(_antiferrodis_A_z[_qp])*_t24121233 + (3*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*Utility::pow<2>(_polar_x[_qp]) + 3*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*Utility::pow<2>(_polar_y[_qp]))*_t42111212 + (4*Utility::pow<2>(_antiferrodis_A_x[_qp])*_polar_x[_qp]*_polar_y[_qp] + 4*Utility::pow<2>(_antiferrodis_A_y[_qp])*_polar_x[_qp]*_polar_y[_qp])*_t42112211 + 
