...
InputParameters PolarElectricEStrong::validParams()
{
  InputParameters params = Kernel::validParams();
  params.addClassDescription("Calculates a residual contribution due to divP (to be used with the electrostatics (Laplace) kernel).");
