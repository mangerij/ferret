...
InputParameters validParams<DzyaloshinskiiDistortDerivative>()
{
  ...
  params.addRequiredParam<Real>("M0", "The scaling of the magnetic vectors");
  params.addRequiredParam<Real>("A0", "The scaling of the AFD vectors");
...
Real
DzyaloshinskiiDistortDerivative::computeQpResidual()
{
  if (_component == 0)
  {
...
Real
DzyaloshinskiiDistortDerivative::computeQpJacobian()
{
  if (_component == 0)
  {
...
Real
DzyaloshinskiiDistortDerivative::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
