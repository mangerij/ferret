...
AFMSublatticeAnisotropy::computeQpResidual()
{
  if (_mag_sub == 0)
  {
    ...
    if (_component == 0)
    {
      return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*((_mag1_x[_qp] + _mag2_x[_qp])*f(0) + (_mag1_y[_qp] + _mag2_y[_qp])*f(1) + (_mag1_z[_qp] + _mag2_z[_qp])*f(2))*
  ...
  else if (_mag_sub == 1)
  {
    ...
    {
      return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*(-(_mag2_y[_qp]*f(0)) + _mag2_x[_qp]*f(1) + _alpha[_qp]*_mag2_z[_qp]*(_mag2_x[_qp]*f(0) + _mag2_y[_qp]*f(1)) - _alpha[_qp]*(Utility::pow<2>(_mag2_x[_qp]) + Utility::pow<2>(_mag2_y[_qp]))*f(2))*((_mag1_x[_qp] + _mag2_x[_qp])*f(0) + (_mag1_y[_qp] + _mag2_y[_qp])*f(1) + (_mag1_z[_qp] + _mag2_z[_qp])*f(2))*
...
AFMSublatticeAnisotropy::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_mag_sub == 0)
  {
    ...
    if (_component == 0)
    {
      ...
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(0)*(-(_mag1_z[_qp]*f(1)) + _mag1_y[_qp]*f(2) + _alpha[_qp]*(-(Utility::pow<2>(_mag1_y[_qp])*f(0)) + _mag1_x[_qp]*_mag1_y[_qp]*f(1) + _mag1_z[_qp]*(-(_mag1_z[_qp]*f(0)) + _mag1_x[_qp]*f(2))))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag2_y_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(1)*(-(_mag1_z[_qp]*f(1)) + _mag1_y[_qp]*f(2) + _alpha[_qp]*(-(Utility::pow<2>(_mag1_y[_qp])*f(0)) + _mag1_x[_qp]*_mag1_y[_qp]*f(1) + _mag1_z[_qp]*(-(_mag1_z[_qp]*f(0)) + _mag1_x[_qp]*f(2))))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag2_z_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(2)*(-(_mag1_z[_qp]*f(1)) + _mag1_y[_qp]*f(2) + _alpha[_qp]*(-(Utility::pow<2>(_mag1_y[_qp])*f(0)) + _mag1_x[_qp]*_mag1_y[_qp]*f(1) + _mag1_z[_qp]*(-(_mag1_z[_qp]*f(0)) + _mag1_x[_qp]*f(2))))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else
        return 0.0;
    }
    else if (_component == 1)
    {
      ...
      {
        return (-2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(0)*(_alpha[_qp]*Utility::pow<2>(_mag1_z[_qp])*f(1) + _mag1_x[_qp]*(-(_alpha[_qp]*_mag1_y[_qp]*f(0)) + _alpha[_qp]*_mag1_x[_qp]*f(1) + f(2)) - _mag1_z[_qp]*(f(0) + _alpha[_qp]*_mag1_y[_qp]*f(2)))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag2_y_var)
      {
        return (-2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(1)*(_alpha[_qp]*Utility::pow<2>(_mag1_z[_qp])*f(1) + _mag1_x[_qp]*(-(_alpha[_qp]*_mag1_y[_qp]*f(0)) + _alpha[_qp]*_mag1_x[_qp]*f(1) + f(2)) - _mag1_z[_qp]*(f(0) + _alpha[_qp]*_mag1_y[_qp]*f(2)))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag2_z_var)
      {
        return (-2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(2)*(_alpha[_qp]*Utility::pow<2>(_mag1_z[_qp])*f(1) + _mag1_x[_qp]*(-(_alpha[_qp]*_mag1_y[_qp]*f(0)) + _alpha[_qp]*_mag1_x[_qp]*f(1) + f(2)) - _mag1_z[_qp]*(f(0) + _alpha[_qp]*_mag1_y[_qp]*f(2)))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else
        return 0.0;
    }
    else if (_component == 2)
    {
      ...
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(0)*(-(_mag1_y[_qp]*f(0)) + _alpha[_qp]*_mag1_x[_qp]*_mag1_z[_qp]*f(0) + _mag1_x[_qp]*f(1) + _alpha[_qp]*_mag1_y[_qp]*_mag1_z[_qp]*f(1) - _alpha[_qp]*(Utility::pow<2>(_mag1_x[_qp]) + Utility::pow<2>(_mag1_y[_qp]))*f(2))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag2_y_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(1)*(-(_mag1_y[_qp]*f(0)) + _alpha[_qp]*_mag1_x[_qp]*_mag1_z[_qp]*f(0) + _mag1_x[_qp]*f(1) + _alpha[_qp]*_mag1_y[_qp]*_mag1_z[_qp]*f(1) - _alpha[_qp]*(Utility::pow<2>(_mag1_x[_qp]) + Utility::pow<2>(_mag1_y[_qp]))*f(2))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag2_z_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(2)*(-(_mag1_y[_qp]*f(0)) + _alpha[_qp]*_mag1_x[_qp]*_mag1_z[_qp]*f(0) + _mag1_x[_qp]*f(1) + _alpha[_qp]*_mag1_y[_qp]*_mag1_z[_qp]*f(1) - _alpha[_qp]*(Utility::pow<2>(_mag1_x[_qp]) + Utility::pow<2>(_mag1_y[_qp]))*f(2))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else
        return 0.0;
    }
  ...
  else if (_mag_sub == 1)
  {
    ...
    if (_component == 0)
    {
      ...
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(0)*(-(_mag2_z[_qp]*f(1)) + _mag2_y[_qp]*f(2) + _alpha[_qp]*(-(Utility::pow<2>(_mag2_y[_qp])*f(0)) + _mag2_x[_qp]*_mag2_y[_qp]*f(1) + _mag2_z[_qp]*(-(_mag2_z[_qp]*f(0)) + _mag2_x[_qp]*f(2))))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag1_y_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(1)*(-(_mag2_z[_qp]*f(1)) + _mag2_y[_qp]*f(2) + _alpha[_qp]*(-(Utility::pow<2>(_mag2_y[_qp])*f(0)) + _mag2_x[_qp]*_mag2_y[_qp]*f(1) + _mag2_z[_qp]*(-(_mag2_z[_qp]*f(0)) + _mag2_x[_qp]*f(2))))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag1_z_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(2)*(-(_mag2_z[_qp]*f(1)) + _mag2_y[_qp]*f(2) + _alpha[_qp]*(-(Utility::pow<2>(_mag2_y[_qp])*f(0)) + _mag2_x[_qp]*_mag2_y[_qp]*f(1) + _mag2_z[_qp]*(-(_mag2_z[_qp]*f(0)) + _mag2_x[_qp]*f(2))))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else
        return 0.0;
    }
    else if (_component == 1)
    {
      ...
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(0)*(-(_alpha[_qp]*Utility::pow<2>(_mag2_z[_qp])*f(1)) - _mag2_x[_qp]*(-(_alpha[_qp]*_mag2_y[_qp]*f(0)) + _alpha[_qp]*_mag2_x[_qp]*f(1) + f(2)) + _mag2_z[_qp]*(f(0) + _alpha[_qp]*_mag2_y[_qp]*f(2)))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag1_y_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(1)*(-(_alpha[_qp]*Utility::pow<2>(_mag2_z[_qp])*f(1)) - _mag2_x[_qp]*(-(_alpha[_qp]*_mag2_y[_qp]*f(0)) + _alpha[_qp]*_mag2_x[_qp]*f(1) + f(2)) + _mag2_z[_qp]*(f(0) + _alpha[_qp]*_mag2_y[_qp]*f(2)))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag1_z_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(2)*(-(_alpha[_qp]*Utility::pow<2>(_mag2_z[_qp])*f(1)) - _mag2_x[_qp]*(-(_alpha[_qp]*_mag2_y[_qp]*f(0)) + _alpha[_qp]*_mag2_x[_qp]*f(1) + f(2)) + _mag2_z[_qp]*(f(0) + _alpha[_qp]*_mag2_y[_qp]*f(2)))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else
        return 0.0;
    }
    else if (_component == 2)
    {
      ...
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(0)*(-(_mag2_y[_qp]*f(0)) + _mag2_x[_qp]*f(1) + _alpha[_qp]*_mag2_z[_qp]*(_mag2_x[_qp]*f(0) + _mag2_y[_qp]*f(1)) - _alpha[_qp]*(Utility::pow<2>(_mag2_x[_qp]) + Utility::pow<2>(_mag2_y[_qp]))*f(2))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag1_y_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(1)*(-(_mag2_y[_qp]*f(0)) + _mag2_x[_qp]*f(1) + _alpha[_qp]*_mag2_z[_qp]*(_mag2_x[_qp]*f(0) + _mag2_y[_qp]*f(1)) - _alpha[_qp]*(Utility::pow<2>(_mag2_x[_qp]) + Utility::pow<2>(_mag2_y[_qp]))*f(2))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else if (jvar == _mag1_z_var)
      {
        return (2.0*_g0[_qp]*_K1[_qp]*(1/_Ms[_qp])*f(2)*(-(_mag2_y[_qp]*f(0)) + _mag2_x[_qp]*f(1) + _alpha[_qp]*_mag2_z[_qp]*(_mag2_x[_qp]*f(0) + _mag2_y[_qp]*f(1)) - _alpha[_qp]*(Utility::pow<2>(_mag2_x[_qp]) + Utility::pow<2>(_mag2_y[_qp]))*f(2))*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha[_qp]));
      }
      else
        return 0.0;
    }
