...
#include "LagrangeConstraintCartLLG.h"
#include "libmesh/utility.h"

registerMooseObject("FerretApp", LagrangeConstraintCartLLG);
...
LagrangeConstraintCartLLG::LagrangeConstraintCartLLG(const InputParameters & parameters)
  :Kernel(parameters),
...
Real
LagrangeConstraintCartLLG::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (jvar == _mag_x_var)
  {
