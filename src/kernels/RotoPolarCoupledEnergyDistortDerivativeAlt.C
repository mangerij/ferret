...
RotoPolarCoupledEnergyDistortDerivativeAlt::computeQpResidual()
{
  if (_component == 0)
  {
   ...
   (4*Utility::pow<3>(_antiferrodis_A_x[_qp])*Utility::pow<2>(_polar_y[_qp]) + 4*Utility::pow<3>(_antiferrodis_A_x[_qp])*Utility::pow<4>(_polar_z[_qp]))*_t4411112222 + 2*_antiferrodis_A_x[_qp]*Utility::pow<6>(_polar_x[_qp])*_t6211111111 + (2*_antiferrodis_A_x[_qp]*Utility::pow<6>(_polar_y[_qp]) + 2*_antiferrodis_A_x[_qp]*Utility::pow<6>(_polar_z[_qp]))*_t6211111122);
  }
  else if (_component == 1)
  {
   ...
   (2*Utility::pow<2>(_antiferrodis_A_x[_qp])*_antiferrodis_A_y[_qp]*Utility::pow<2>(_polar_x[_qp]) + 2*_antiferrodis_A_y[_qp]*(Utility::pow<2>(_antiferrodis_A_x[_qp]) + Utility::pow<2>(_antiferrodis_A_z[_qp]))*Utility::pow<2>(_polar_y[_qp]) + 2*_antiferrodis_A_y[_qp]*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<2>(_polar_z[_qp]))*_t24111122 + (4*Utility::pow<3>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_x[_qp]) + 4*Utility::pow<3>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_z[_qp]))*_t24112222 + 
   (2*_antiferrodis_A_y[_qp]*Utility::pow<2>(_antiferrodis_A_z[_qp])*Utility::pow<2>(_polar_x[_qp]) + 2*Utility::pow<2>(_antiferrodis_A_x[_qp])*_antiferrodis_A_y[_qp]*Utility::pow<2>(_polar_z[_qp]))*_t24112233 + (Utility::pow<3>(_antiferrodis_A_x[_qp])*_polar_x[_qp]*_polar_y[_qp] + Utility::pow<3>(_antiferrodis_A_z[_qp])*_polar_y[_qp]*_polar_z[_qp] + 3*Utility::pow<2>(_antiferrodis_A_y[_qp])*_polar_y[_qp]*(_antiferrodis_A_x[_qp]*_polar_x[_qp] + _antiferrodis_A_z[_qp]*_polar_z[_qp]))*_t24121112 + 
   (_antiferrodis_A_x[_qp]*Utility::pow<2>(_antiferrodis_A_z[_qp])*_polar_x[_qp]*_polar_y[_qp] + 2*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_z[_qp] + Utility::pow<2>(_antiferrodis_A_x[_qp])*_antiferrodis_A_z[_qp]*_polar_y[_qp]*_polar_z[_qp])*_t24121233 + 6*Utility::pow<5>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_y[_qp])*_t2611111111 + (6*Utility::pow<5>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_x[_qp]) + 6*Utility::pow<5>(_antiferrodis_A_y[_qp])*Utility::pow<2>(_polar_z[_qp]))*_t2611222222 + 
