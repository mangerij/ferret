...
InteractionCartLLG::computeQpResidual()
{
  if (_component == 0)
  {
    return (_g0*(_alpha*_potential_H_int_grad[_qp](0)*(-1 + Utility::pow<2>(_mag_x[_qp])) + _potential_H_int_grad[_qp](2)*_mag_y[_qp] + _potential_H_int_grad[_qp](1)*_mag_x[_qp]*_mag_y[_qp] - _potential_H_int_grad[_qp](1)*_mag_z[_qp] + _alpha*_potential_H_int_grad[_qp](2)*_mag_x[_qp]*_mag_z[_qp])*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
  }
  else if (_component == 1)
  {
    return (_g0*(-(_potential_H_int_grad[_qp](2)*_mag_x[_qp]) + _potential_H_int_grad[_qp](0)*_mag_z[_qp] + _alpha*(_potential_H_int_grad[_qp](0)*_mag_x[_qp]*_mag_y[_qp] + _potential_H_int_grad[_qp](1)*(-1 + Utility::pow<2>(_mag_y[_qp])) + _potential_H_int_grad[_qp](2)*_mag_y[_qp]*_mag_z[_qp]))*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
  }
  else if (_component == 2)
  {
    return (_g0*(_potential_H_int_grad[_qp](1)*_mag_x[_qp] - _potential_H_int_grad[_qp](0)*_mag_y[_qp] + _alpha*((_potential_H_int_grad[_qp](0)*_mag_x[_qp] + _potential_H_int_grad[_qp](1)*_mag_y[_qp])*_mag_z[_qp] + _potential_H_int_grad[_qp](2)*(-1 + Utility::pow<2>(_mag_z[_qp]))))*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
  }
  else
    return 0.0;
}
...
InteractionCartLLG::computeQpJacobian()
{
  if (_component == 0)
  {
    return (_g0*(2*_alpha*_potential_H_int_grad[_qp](0)*_mag_x[_qp] + _potential_H_int_grad[_qp](1)*_mag_y[_qp] + _alpha*_potential_H_int_grad[_qp](2)*_mag_z[_qp])*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
  }
  else if (_component == 1)
  {
...
InteractionCartLLG::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
    if (jvar == _mag_y_var)
    {
      return (_g0*(_potential_H_int_grad[_qp](2) + _potential_H_int_grad[_qp](1)*_mag_x[_qp])*_phi[_j][_qp]*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
    }
    ...
    {
      return (_g0*(_alpha*_grad_phi[_j][_qp](0)*(-1 + Utility::pow<2>(_mag_x[_qp])) + _grad_phi[_j][_qp](2)*_mag_y[_qp] + _grad_phi[_j][_qp](1)*_mag_x[_qp]*_mag_y[_qp] - _grad_phi[_j][_qp](1)*_mag_z[_qp] + _alpha*_grad_phi[_j][_qp](2)*_mag_x[_qp]*_mag_z[_qp])*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
    }
  ...
  else if (_component == 1)
  {
    ...
    {
      return (_g0*(-(_grad_phi[_j][_qp](2)*_mag_x[_qp]) + _grad_phi[_j][_qp](0)*_mag_z[_qp] + _alpha*(_grad_phi[_j][_qp](0)*_mag_x[_qp]*_mag_y[_qp] + _grad_phi[_j][_qp](1)*(-1 + Utility::pow<2>(_mag_y[_qp])) + _grad_phi[_j][_qp](2)*_mag_y[_qp]*_mag_z[_qp]))*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
    }
    else if (jvar == _potential_H_ext_var)
    {
      return 0.0;
  ...
  else if (_component == 2)
  {
    ...
    {
      return (_g0*(_grad_phi[_j][_qp](1)*_mag_x[_qp] - _grad_phi[_j][_qp](0)*_mag_y[_qp] + _alpha*((_grad_phi[_j][_qp](0)*_mag_x[_qp] + _grad_phi[_j][_qp](1)*_mag_y[_qp])*_mag_z[_qp] + _grad_phi[_j][_qp](2)*(-1 + Utility::pow<2>(_mag_z[_qp]))))*_test[_i][_qp])/(1 + Utility::pow<2>(_alpha));
    }
    else if (jvar == _potential_H_ext_var)
    {
      return 0.0;
