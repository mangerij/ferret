...
registerMooseObject("FerretApp", DampedConstrainedExchangeLLG);
...
DampedConstrainedExchangeLLG::DampedConstrainedExchangeLLG(const InputParameters & parameters)
  :Kernel(parameters),
...
Real
DampedConstrainedExchangeLLG::computeQpResidual()
{
  if (_component == 0)
  {
...
Real
DampedConstrainedExchangeLLG::computeQpJacobian()
{
  if (_component == 0)
  {
...
Real
DampedConstrainedExchangeLLG::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
