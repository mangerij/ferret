...
#include "AFMSublatticeAnisotropyAltTightlyCoupled.h"
#include "libmesh/utility.h"

registerMooseObject("FerretApp", AFMSublatticeAnisotropyAltTightlyCoupled);

InputParameters AFMSublatticeAnisotropyAltTightlyCoupled::validParams()
{
...
AFMSublatticeAnisotropyAltTightlyCoupled::AFMSublatticeAnisotropyAltTightlyCoupled(const InputParameters & parameters)
  :Kernel(parameters),
...
Real
AFMSublatticeAnisotropyAltTightlyCoupled::computeQpResidual()
{
  if (_mag_sub == 0)
  {
...
Real
AFMSublatticeAnisotropyAltTightlyCoupled::computeQpJacobian()
{
  if (_mag_sub == 0)
  {
    RealVectorValue w(_polar_x[_qp], _polar_y[_qp], _polar_z[_qp]);
...
Real
AFMSublatticeAnisotropyAltTightlyCoupled::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_mag_sub == 0)
  {
    RealVectorValue w(_polar_x[_qp], _polar_y[_qp], _polar_z[_qp]);
