...
RotoPolarCoupledEnergyDistortDerivative::computeQpResidual()
{
  ...
  else if (_component == 1)
  {
   ...
   ((_antiferrodis_A_x[_qp]*std::pow(_antiferrodis_A_z[_qp],2)*_polar_x[_qp]*_polar_y[_qp] + 2*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_z[_qp] + std::pow(_antiferrodis_A_x[_qp],2)*_antiferrodis_A_z[_qp]*_polar_y[_qp]*_polar_z[_qp])*_t24121233)/24. + (6*std::pow(_antiferrodis_A_y[_qp],5)*std::pow(_polar_x[_qp],2) + 6*std::pow(_antiferrodis_A_y[_qp],5)*std::pow(_polar_z[_qp],2))*_t2611222222 + 2*_antiferrodis_A_y[_qp]*std::pow(_polar_y[_qp],4)*_t42111111 + 
   (2*_antiferrodis_A_y[_qp]*std::pow(_polar_x[_qp],4) + 2*_antiferrodis_A_y[_qp]*std::pow(_polar_z[_qp],4))*_t42111122 + ((2*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*std::pow(_polar_x[_qp],3)*_polar_y[_qp] + 2*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_y[_qp]*std::pow(_polar_z[_qp],3) + std::pow(_polar_y[_qp],3)*(std::pow(_antiferrodis_A_x[_qp],2)*_polar_x[_qp] + std::pow(_antiferrodis_A_z[_qp],2)*_polar_z[_qp]))*_t42111212)/8. + 
   (_antiferrodis_A_y[_qp]*std::pow(_polar_y[_qp],2)*(std::pow(_polar_x[_qp],2) + std::pow(_polar_z[_qp],2))*_t42112211)/3. + (_antiferrodis_A_y[_qp]*std::pow(_polar_x[_qp],2)*std::pow(_polar_z[_qp],2)*_t42112233)/3. + ((_antiferrodis_A_z[_qp]*std::pow(_polar_x[_qp],2)*_polar_y[_qp]*_polar_z[_qp] + _antiferrodis_A_x[_qp]*_polar_x[_qp]*_polar_y[_qp]*std::pow(_polar_z[_qp],2))*_t42123312)/24. + 4*std::pow(_antiferrodis_A_y[_qp],3)*std::pow(_polar_y[_qp],4)*_t4411111111 + 
...
RotoPolarCoupledEnergyDistortDerivative::computeQpJacobian()
{
  if (_component == 0)
  {
   ...
   ((2*(std::pow(_antiferrodis_A_y[_qp],2) + std::pow(_antiferrodis_A_z[_qp],2))*std::pow(_polar_x[_qp],2) + 2*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_y[_qp],2) + 2*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_z[_qp],2))*_t24111122)/6. + (12*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_y[_qp],2) + 12*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_z[_qp],2))*_t24112222 + 
   ((2*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_y[_qp],2) + 2*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_z[_qp],2))*_t24112233)/6. + (3*_antiferrodis_A_x[_qp]*_polar_x[_qp]*(_antiferrodis_A_y[_qp]*_polar_y[_qp] + _antiferrodis_A_z[_qp]*_polar_z[_qp])*_t24121112)/4. + (_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_y[_qp]*_polar_z[_qp]*_t24121233)/12. + 
   (30*std::pow(_antiferrodis_A_x[_qp],4)*std::pow(_polar_y[_qp],2) + 30*std::pow(_antiferrodis_A_x[_qp],4)*std::pow(_polar_z[_qp],2))*_t2611222222 + 2*std::pow(_polar_x[_qp],4)*_t42111111 + (2*std::pow(_polar_y[_qp],4) + 2*std::pow(_polar_z[_qp],4))*_t42111122 + ((2*_antiferrodis_A_y[_qp]*_polar_x[_qp]*std::pow(_polar_y[_qp],3) + 2*_antiferrodis_A_z[_qp]*_polar_x[_qp]*std::pow(_polar_z[_qp],3))*_t42111212)/8. + (std::pow(_polar_x[_qp],2)*(std::pow(_polar_y[_qp],2) + std::pow(_polar_z[_qp],2))*_t42112211)/3. + (std::pow(_polar_y[_qp],2)*std::pow(_polar_z[_qp],2)*_t42112233)/3. + 12*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_x[_qp],4)*_t4411111111 + 
   (12*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_y[_qp],2) + 12*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_z[_qp],4))*_t4411112222 + 2*std::pow(_polar_x[_qp],6)*_t6211111111 + (2*std::pow(_polar_y[_qp],6) + 2*std::pow(_polar_z[_qp],6))*_t6211111122);
  }
  else if (_component == 1)
  {
   ...
   ((2*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_x[_qp],2) + 2*(std::pow(_antiferrodis_A_x[_qp],2) + std::pow(_antiferrodis_A_z[_qp],2))*std::pow(_polar_y[_qp],2) + 2*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_z[_qp],2))*_t24111122)/6. + (12*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_x[_qp],2) + 12*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_z[_qp],2))*_t24112222 + 
   ((2*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_x[_qp],2) + 2*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_z[_qp],2))*_t24112233)/6. + (3*_antiferrodis_A_y[_qp]*_polar_y[_qp]*(_antiferrodis_A_x[_qp]*_polar_x[_qp] + _antiferrodis_A_z[_qp]*_polar_z[_qp])*_t24121112)/4. + (_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_z[_qp]*_t24121233)/12. + 
   (30*std::pow(_antiferrodis_A_y[_qp],4)*std::pow(_polar_x[_qp],2) + 30*std::pow(_antiferrodis_A_y[_qp],4)*std::pow(_polar_z[_qp],2))*_t2611222222 + 2*std::pow(_polar_y[_qp],4)*_t42111111 + (2*std::pow(_polar_x[_qp],4) + 2*std::pow(_polar_z[_qp],4))*_t42111122 + ((2*_antiferrodis_A_x[_qp]*std::pow(_polar_x[_qp],3)*_polar_y[_qp] + 2*_antiferrodis_A_z[_qp]*_polar_y[_qp]*std::pow(_polar_z[_qp],3))*_t42111212)/8. + 
   (std::pow(_polar_y[_qp],2)*(std::pow(_polar_x[_qp],2) + std::pow(_polar_z[_qp],2))*_t42112211)/3. + (std::pow(_polar_x[_qp],2)*std::pow(_polar_z[_qp],2)*_t42112233)/3. + 12*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_y[_qp],4)*_t4411111111 + 
   (12*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_x[_qp],4) + 12*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_z[_qp],4))*_t4411112222 + 2*std::pow(_polar_y[_qp],6)*_t6211111111 + (2*std::pow(_polar_x[_qp],6) + 2*std::pow(_polar_z[_qp],6))*_t6211111122);
  }
  else if (_component == 2)
  {
   ...
   ((2*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_x[_qp],2) + 2*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_y[_qp],2) + 2*(std::pow(_antiferrodis_A_x[_qp],2) + std::pow(_antiferrodis_A_y[_qp],2))*std::pow(_polar_z[_qp],2))*_t24111122)/6. + (12*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_x[_qp],2) + 12*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_y[_qp],2))*_t24112222 + 
   ((2*std::pow(_antiferrodis_A_y[_qp],2)*std::pow(_polar_x[_qp],2) + 2*std::pow(_antiferrodis_A_x[_qp],2)*std::pow(_polar_y[_qp],2))*_t24112233)/6. + (3*_antiferrodis_A_z[_qp]*(_antiferrodis_A_x[_qp]*_polar_x[_qp] + _antiferrodis_A_y[_qp]*_polar_y[_qp])*_polar_z[_qp]*_t24121112)/4. + (_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_polar_x[_qp]*_polar_y[_qp]*_t24121233)/12. + 
   (30*std::pow(_antiferrodis_A_z[_qp],4)*std::pow(_polar_x[_qp],2) + 30*std::pow(_antiferrodis_A_z[_qp],4)*std::pow(_polar_y[_qp],2))*_t2611222222 + 2*std::pow(_polar_z[_qp],4)*_t42111111 + (2*std::pow(_polar_x[_qp],4) + 2*std::pow(_polar_y[_qp],4))*_t42111122 + ((2*_antiferrodis_A_x[_qp]*std::pow(_polar_x[_qp],3)*_polar_z[_qp] + 2*_antiferrodis_A_y[_qp]*std::pow(_polar_y[_qp],3)*_polar_z[_qp])*_t42111212)/8. + 
   ((std::pow(_polar_x[_qp],2) + std::pow(_polar_y[_qp],2))*std::pow(_polar_z[_qp],2)*_t42112211)/3. + (std::pow(_polar_x[_qp],2)*std::pow(_polar_y[_qp],2)*_t42112233)/3. + 12*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_z[_qp],4)*_t4411111111 + 
   (12*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_x[_qp],4) + 12*std::pow(_antiferrodis_A_z[_qp],2)*std::pow(_polar_y[_qp],2))*_t4411112222 + 2*std::pow(_polar_z[_qp],6)*_t6211111111 + (2*std::pow(_polar_x[_qp],6) + 2*std::pow(_polar_y[_qp],6))*_t6211111122);
  }
  else
    return 0.0;
}
...
RotoPolarCoupledEnergyDistortDerivative::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
   ...
   (2*_antiferrodis_A_x[_qp]*std::pow(_polar_x[_qp],2)*_polar_z[_qp]*_t42112211)/3. + (2*_antiferrodis_A_x[_qp]*std::pow(_polar_y[_qp],2)*_polar_z[_qp]*_t42112233)/3. + ((_antiferrodis_A_z[_qp]*_polar_x[_qp]*std::pow(_polar_y[_qp],2) + 2*_antiferrodis_A_y[_qp]*_polar_x[_qp]*_polar_y[_qp]*_polar_z[_qp])*_t42123312)/24. + 16*std::pow(_antiferrodis_A_x[_qp],3)*std::pow(_polar_z[_qp],3)*_t4411112222 + 12*_antiferrodis_A_x[_qp]*std::pow(_polar_z[_qp],5)*_t6211111122);
    ...
    {
      return _test[_i][_qp] * _phi[_j][_qp] *  ((_polar_x[_qp]*_polar_y[_qp]*_t1212)/4. + ((4*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*std::pow(_polar_x[_qp],2) + 4*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*std::pow(_polar_y[_qp],2))*_t24111122)/6. + (2*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*std::pow(_polar_z[_qp],2)*_t24112233)/3. + ((3*std::pow(_antiferrodis_A_x[_qp],2)*_polar_x[_qp]*_polar_y[_qp] + 3*std::pow(_antiferrodis_A_y[_qp],2)*_polar_x[_qp]*_polar_y[_qp])*_t24121112)/8. + 
   ((std::pow(_antiferrodis_A_z[_qp],2)*_polar_x[_qp]*_polar_y[_qp] + 2*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_z[_qp] + 2*_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_y[_qp]*_polar_z[_qp])*_t24121233)/24. + ((2*_antiferrodis_A_y[_qp]*std::pow(_polar_x[_qp],3)*_polar_y[_qp] + 2*_antiferrodis_A_x[_qp]*_polar_x[_qp]*std::pow(_polar_y[_qp],3))*_t42111212)/8. + (_polar_x[_qp]*_polar_y[_qp]*std::pow(_polar_z[_qp],2)*_t42123312)/24.);
    }
    else if (jvar == _antiferrodis_A_z_var)
    {
      return _test[_i][_qp] * _phi[_j][_qp] *  ((_polar_x[_qp]*_polar_z[_qp]*_t1212)/4. + ((4*_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*std::pow(_polar_x[_qp],2) + 4*_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*std::pow(_polar_z[_qp],2))*_t24111122)/6. + (2*_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*std::pow(_polar_y[_qp],2)*_t24112233)/3. + ((3*std::pow(_antiferrodis_A_x[_qp],2)*_polar_x[_qp]*_polar_z[_qp] + 3*std::pow(_antiferrodis_A_z[_qp],2)*_polar_x[_qp]*_polar_z[_qp])*_t24121112)/8. + 
   ((2*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_y[_qp] + std::pow(_antiferrodis_A_y[_qp],2)*_polar_x[_qp]*_polar_z[_qp] + 2*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_polar_y[_qp]*_polar_z[_qp])*_t24121233)/24. + ((2*_antiferrodis_A_z[_qp]*std::pow(_polar_x[_qp],3)*_polar_z[_qp] + 2*_antiferrodis_A_x[_qp]*_polar_x[_qp]*std::pow(_polar_z[_qp],3))*_t42111212)/8. + (_polar_x[_qp]*std::pow(_polar_y[_qp],2)*_polar_z[_qp]*_t42123312)/24.);
    }
    else
    {
      return 0.0;
  ...
  else if (_component == 1)
  {
   ...
   ((std::pow(_antiferrodis_A_z[_qp],2)*_polar_x[_qp]*_polar_y[_qp] + 2*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_z[_qp] + 2*_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_y[_qp]*_polar_z[_qp])*_t24121233)/24. + ((2*_antiferrodis_A_y[_qp]*std::pow(_polar_x[_qp],3)*_polar_y[_qp] + 2*_antiferrodis_A_x[_qp]*_polar_x[_qp]*std::pow(_polar_y[_qp],3))*_t42111212)/8. + (_polar_x[_qp]*_polar_y[_qp]*std::pow(_polar_z[_qp],2)*_t42123312)/24.);
    ...
    {
      return _test[_i][_qp] * _phi[_j][_qp] *  ((_polar_y[_qp]*_polar_z[_qp]*_t1212)/4. + ((4*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*std::pow(_polar_y[_qp],2) + 4*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*std::pow(_polar_z[_qp],2))*_t24111122)/6. + (2*_antiferrodis_A_y[_qp]*_antiferrodis_A_z[_qp]*std::pow(_polar_x[_qp],2)*_t24112233)/3. + ((3*std::pow(_antiferrodis_A_y[_qp],2)*_polar_y[_qp]*_polar_z[_qp] + 3*std::pow(_antiferrodis_A_z[_qp],2)*_polar_y[_qp]*_polar_z[_qp])*_t24121112)/8. + 
   ((2*_antiferrodis_A_x[_qp]*_antiferrodis_A_z[_qp]*_polar_x[_qp]*_polar_y[_qp] + 2*_antiferrodis_A_x[_qp]*_antiferrodis_A_y[_qp]*_polar_x[_qp]*_polar_z[_qp] + std::pow(_antiferrodis_A_x[_qp],2)*_polar_y[_qp]*_polar_z[_qp])*_t24121233)/24. + ((2*_antiferrodis_A_z[_qp]*std::pow(_polar_y[_qp],3)*_polar_z[_qp] + 2*_antiferrodis_A_y[_qp]*_polar_y[_qp]*std::pow(_polar_z[_qp],3))*_t42111212)/8. + (std::pow(_polar_x[_qp],2)*_polar_y[_qp]*_polar_z[_qp]*_t42123312)/24.);
    }
    else
    {
      return 0.0;
