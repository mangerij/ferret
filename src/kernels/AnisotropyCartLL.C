...
AnisotropyCartLL::computeQpJacobian()
{
  if (_component == 0)
  {
    return -(1.0/_mu0[_qp])*(2*_g0[_qp]*(-(_nx[_qp]*(_mag_z[_qp]*_ny[_qp] - _mag_y[_qp]*_nz[_qp])*(_K1[_qp] + 6*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp]))) + _alpha[_qp]*_Ms[_qp]*(-2*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*
  ...
  {
    return -(1.0/_mu0[_qp])*(2*_g0[_qp]*(-(((_mag_y[_qp]*_nx[_qp] - _mag_x[_qp]*_ny[_qp])*_nz[_qp]*(_K1[_qp] + 6*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])))/_Ms[_qp]) + _alpha[_qp]*(-2*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*
...
AnisotropyCartLL::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
    if (jvar == _mag_y_var)
    {
      return -(1.0/_mu0[_qp])*(2*_g0[_qp]*((_alpha[_qp]*_Ms[_qp]*(2*_mag_y[_qp]*_nx[_qp] - _mag_x[_qp]*_ny[_qp]) + _nz[_qp])*(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*(_K1[_qp] + 2*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])) - 
    ...
    {
      return -(1.0/_mu0[_qp])*(2*_g0[_qp]*(-((_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*(_ny[_qp] + _alpha[_qp]*_Ms[_qp]*(-2*_mag_z[_qp]*_nx[_qp] + _mag_x[_qp]*_nz[_qp]))*(_K1[_qp] + 2*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp]))) - 
  ...
  else if (_component == 1)
  {
    if (jvar == _mag_x_var)
    {
      return -(1.0/_mu0[_qp])*(2*_g0[_qp]*(-((_alpha[_qp]*_Ms[_qp]*(_mag_y[_qp]*_nx[_qp] - 2*_mag_x[_qp]*_ny[_qp]) + _nz[_qp])*(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*(_K1[_qp] + 2*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp]))) + 
    ...
    {
      return -(1.0/_mu0[_qp])*(2*_g0[_qp]*((_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*(_nx[_qp] + _alpha[_qp]*_Ms[_qp]*(2*_mag_z[_qp]*_ny[_qp] - _mag_y[_qp]*_nz[_qp]))*(_K1[_qp] + 2*_K2[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])) + 
  ...
  else if (_component == 2)
  {
    if (jvar == _mag_x_var)
    {
      return -(1.0/_mu0[_qp])*(2*_g0[_qp]*(4*_K2[_qp]*_nx[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*(-(_mag_y[_qp]*_nx[_qp]) + _mag_x[_qp]*_ny[_qp] + _alpha[_qp]*_Ms[_qp]*(-(_mag_z[_qp]*(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp])) + (Utility::pow<2>(_mag_x[_qp]) + Utility::pow<2>(_mag_y[_qp]))*_nz[_qp])) + 
    ...
    {
      return -(1.0/_mu0[_qp])*(2*_g0[_qp]*(4*_K2[_qp]*_ny[_qp]*Utility::pow<2>(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp] + _mag_z[_qp]*_nz[_qp])*(-(_mag_y[_qp]*_nx[_qp]) + _mag_x[_qp]*_ny[_qp] + _alpha[_qp]*_Ms[_qp]*(-(_mag_z[_qp]*(_mag_x[_qp]*_nx[_qp] + _mag_y[_qp]*_ny[_qp])) + (Utility::pow<2>(_mag_x[_qp]) + Utility::pow<2>(_mag_y[_qp]))*_nz[_qp])) - 
