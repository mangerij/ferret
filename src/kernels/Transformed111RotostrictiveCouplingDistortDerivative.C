...
Transformed111RotostrictiveCouplingDistortDerivative::computeQpResidual()
{
  if (_component == 0)
  {
    return -0.5*_test[_i][_qp] * (-0.33333333333333333333*(_antiferrodis_A_z[_qp]*(_r11[_qp]*(1.4142135623730950488*_u_x_grad[_qp](0) - 2.*_u_x_grad[_qp](2) - 1.4142135623730950488*_u_y_grad[_qp](1) - 2.*_u_z_grad[_qp](0)) - 
      ...
      _antiferrodis_A_y[_qp]*(-1.*_r11[_qp]*(_u_x_grad[_qp](1) + _u_y_grad[_qp](0) + 1.4142135623730950488*(_u_y_grad[_qp](2) + _u_z_grad[_qp](1))) + _r12[_qp]*(_u_x_grad[_qp](1) + _u_y_grad[_qp](0) + 1.4142135623730950488*(_u_y_grad[_qp](2) + _u_z_grad[_qp](1))) + 
         _r44[_qp]*(-4.*_u_x_grad[_qp](1) - 4.*_u_y_grad[_qp](0) + 2.8284271247461900976*(_u_y_grad[_qp](2) + _u_z_grad[_qp](1))))) + 
   0.33333333333333333333*_antiferrodis_A_x[_qp]*(_r44[_qp]*(6.*_u_x_grad[_qp](0) + 2.8284271247461900976*_u_x_grad[_qp](2) - 2.*_u_y_grad[_qp](1) + 2.8284271247461900976*_u_z_grad[_qp](0) - 4.*_u_z_grad[_qp](2)) + 
  ...
  {
    return -0.5*_test[_i][_qp] * (0.33333333333333333333*_antiferrodis_A_z[_qp]*(1.4142135623730950488*_r11[_qp]*_u_x_grad[_qp](1) - 1.4142135623730950488*_r12[_qp]*_u_x_grad[_qp](1) + 1.4142135623730950488*_r11[_qp]*_u_y_grad[_qp](0) - 
   ...
   0.33333333333333333333*_antiferrodis_A_x[_qp]*(-1.*_r11[_qp]*(_u_x_grad[_qp](1) + _u_y_grad[_qp](0) + 1.4142135623730950488*(_u_y_grad[_qp](2) + _u_z_grad[_qp](1))) + 
   ...
   0.33333333333333333333*_antiferrodis_A_y[_qp]*(-2.*_r44[_qp]*(_u_x_grad[_qp](0) + 1.4142135623730950488*_u_x_grad[_qp](2) - 3.*_u_y_grad[_qp](1) + 1.4142135623730950488*_u_z_grad[_qp](0) + 2.*_u_z_grad[_qp](2)) + 
  ...
  {
    return -0.5*_test[_i][_qp] * (-0.33333333333333333333*_antiferrodis_A_x[_qp]*(_r11[_qp]*(1.4142135623730950488*_u_x_grad[_qp](0) - 2.*_u_x_grad[_qp](2) - 1.4142135623730950488*_u_y_grad[_qp](1) - 2.*_u_z_grad[_qp](0)) - 
      2.*_r44[_qp]*(1.4142135623730950488*_u_x_grad[_qp](0) + _u_x_grad[_qp](2) - 1.4142135623730950488*_u_y_grad[_qp](1) + _u_z_grad[_qp](0)) + 
      _r12[_qp]*(-1.4142135623730950488*_u_x_grad[_qp](0) + 2.*_u_x_grad[_qp](2) + 1.4142135623730950488*_u_y_grad[_qp](1) + 2.*_u_z_grad[_qp](0))) + 
   0.33333333333333333333*_antiferrodis_A_y[_qp]*(1.4142135623730950488*_r11[_qp]*_u_x_grad[_qp](1) - 1.4142135623730950488*_r12[_qp]*_u_x_grad[_qp](1) + 1.4142135623730950488*_r11[_qp]*_u_y_grad[_qp](0) - 
      1.4142135623730950488*_r12[_qp]*_u_y_grad[_qp](0) + 2.*_r11[_qp]*(_u_y_grad[_qp](2) + _u_z_grad[_qp](1)) - 2.*_r12[_qp]*(_u_y_grad[_qp](2) + _u_z_grad[_qp](1)) + 
      2.*_r44[_qp]*(-1.4142135623730950488*_u_x_grad[_qp](1) - 1.4142135623730950488*_u_y_grad[_qp](0) + _u_y_grad[_qp](2) + _u_z_grad[_qp](1))) + 
   0.6666666666666666667*_antiferrodis_A_z[_qp]*(-2.*_r44[_qp]*(_u_x_grad[_qp](0) + _u_y_grad[_qp](1) - 2.*_u_z_grad[_qp](2)) + _r11[_qp]*(_u_x_grad[_qp](0) + _u_y_grad[_qp](1) + _u_z_grad[_qp](2)) + 2.*_r12[_qp]*(_u_x_grad[_qp](0) + _u_y_grad[_qp](1) + _u_z_grad[_qp](2))));
  }
  else
    return 0.0;
}
...
Transformed111RotostrictiveCouplingDistortDerivative::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_component == 0)
  {
   ...
   _r44[_qp]*(0.9428090415820633659*_u_x_grad[_qp](0) + 0.6666666666666666667*_u_x_grad[_qp](2) - 0.9428090415820633659*_u_y_grad[_qp](1) + 0.6666666666666666667*_u_z_grad[_qp](0)));
    ...
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](0)*_antiferrodis_A_z[_qp]*(-9.428090415820634*_r11[_qp] + 9.428090415820634*_r12[_qp] + 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_y[_qp]*(6.666666666666666*_r11[_qp] - 6.666666666666666*_r12[_qp] + 26.666666666666664*_r44[_qp]) + _grad_phi[_j][_qp](0)*_antiferrodis_A_x[_qp]*(20.*_r11[_qp] + 20.*_r12[_qp] + 40.*_r44[_qp]) + 
   _grad_phi[_j][_qp](2)*(_antiferrodis_A_z[_qp]*(13.333333333333332*_r11[_qp] - 13.333333333333332*_r12[_qp] + 13.333333333333332*_r44[_qp]) + 
      _antiferrodis_A_x[_qp]*(-9.428090415820634*_r11[_qp] + 9.428090415820634*_r12[_qp] + 18.856180831641268*_r44[_qp])));
    }
    else if (jvar == _u_y_var)
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](2)*_antiferrodis_A_y[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_z[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_x[_qp]*(6.666666666666667*_r11[_qp] + 33.333333333333336*_r12[_qp] - 13.333333333333334*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_y[_qp]*(6.666666666666667*_r11[_qp] - 6.666666666666667*_r12[_qp] + 26.666666666666668*_r44[_qp]));
    }
    else if (jvar == _u_z_var)
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](2)*_antiferrodis_A_x[_qp]*(13.333333333333332*_r11[_qp] + 26.666666666666664*_r12[_qp] - 26.666666666666664*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_y[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_z[_qp]*(13.333333333333332*_r11[_qp] - 13.333333333333332*_r12[_qp] + 13.333333333333332*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_x[_qp]*(-9.428090415820634*_r11[_qp] + 9.428090415820634*_r12[_qp] + 18.856180831641268*_r44[_qp]));
    }
    else
    {
      return 0.0;
  ...
  else if (_component == 1)
  {
   ...
   0.6666666666666666667*_r44[_qp]*(-1.4142135623730950488*_u_x_grad[_qp](1) - 1.4142135623730950488*_u_y_grad[_qp](0) + _u_y_grad[_qp](2) + _u_z_grad[_qp](1)));
    ...
    else if (jvar == _u_x_var)
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](2)*_antiferrodis_A_y[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_z[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_y[_qp]*(6.666666666666667*_r11[_qp] + 33.333333333333336*_r12[_qp] - 13.333333333333334*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_x[_qp]*(6.666666666666667*_r11[_qp] - 6.666666666666667*_r12[_qp] + 26.666666666666668*_r44[_qp]));
    }
    else if (jvar == _u_y_var)
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](0)*_antiferrodis_A_z[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_x[_qp]*(6.666666666666666*_r11[_qp] - 6.666666666666666*_r12[_qp] + 26.666666666666664*_r44[_qp]) + _grad_phi[_j][_qp](1)*_antiferrodis_A_y[_qp]*(20.*_r11[_qp] + 20.*_r12[_qp] + 40.*_r44[_qp]) + 
   _grad_phi[_j][_qp](2)*(_antiferrodis_A_x[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
      _antiferrodis_A_z[_qp]*(13.333333333333332*_r11[_qp] - 13.333333333333332*_r12[_qp] + 13.333333333333332*_r44[_qp])));
    }
    else if (jvar == _u_z_var)
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](2)*_antiferrodis_A_y[_qp]*(13.333333333333334*_r11[_qp] + 26.666666666666668*_r12[_qp] - 26.666666666666668*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_x[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_y[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_z[_qp]*(13.333333333333334*_r11[_qp] - 13.333333333333334*_r12[_qp] + 13.333333333333334*_r44[_qp]));
    }
    else
    {
      return 0.0;
  ...
  else if (_component == 2)
  {
   ...
   0.6666666666666666667*_r44[_qp]*(-1.4142135623730950488*_u_x_grad[_qp](1) - 1.4142135623730950488*_u_y_grad[_qp](0) + _u_y_grad[_qp](2) + _u_z_grad[_qp](1)));
    ...
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](0)*_antiferrodis_A_z[_qp]*(13.333333333333334*_r11[_qp] + 26.666666666666668*_r12[_qp] - 26.666666666666668*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_y[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](2)*_antiferrodis_A_x[_qp]*(13.333333333333334*_r11[_qp] - 13.333333333333334*_r12[_qp] + 13.333333333333334*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_x[_qp]*(-9.428090415820634*_r11[_qp] + 9.428090415820634*_r12[_qp] + 18.856180831641268*_r44[_qp]));
    }
    else if (jvar == _u_y_var)
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](1)*_antiferrodis_A_z[_qp]*(13.333333333333334*_r11[_qp] + 26.666666666666668*_r12[_qp] - 26.666666666666668*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_x[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](0)*_antiferrodis_A_y[_qp]*(9.428090415820634*_r11[_qp] - 9.428090415820634*_r12[_qp] - 18.856180831641268*_r44[_qp]) + 
   _grad_phi[_j][_qp](2)*_antiferrodis_A_y[_qp]*(13.333333333333334*_r11[_qp] - 13.333333333333334*_r12[_qp] + 13.333333333333334*_r44[_qp]));
    }
    else if (jvar == _u_z_var)
    {
      return -0.5*_test[_i][_qp] * (_grad_phi[_j][_qp](0)*_antiferrodis_A_x[_qp]*(13.333333333333334*_r11[_qp] - 13.333333333333334*_r12[_qp] + 13.333333333333334*_r44[_qp]) + 
   _grad_phi[_j][_qp](1)*_antiferrodis_A_y[_qp]*(13.333333333333334*_r11[_qp] - 13.333333333333334*_r12[_qp] + 13.333333333333334*_r44[_qp]) + 
   _grad_phi[_j][_qp](2)*_antiferrodis_A_z[_qp]*(13.333333333333334*_r11[_qp] + 26.666666666666668*_r12[_qp] + 53.333333333333336*_r44[_qp]));
    }
    else
    {
      return 0.0;
