...
#include "Transformed111GlobalBFOMaterialRVEUserObject.h"
...
Transformed111GlobalBFOMaterialRVEUserObject::Transformed111GlobalBFOMaterialRVEUserObject(const InputParameters & parameters)
...
void
Transformed111GlobalBFOMaterialRVEUserObject::initialize()
{
  _residual.zero();
  _jacobian.zero();
}
...
void
Transformed111GlobalBFOMaterialRVEUserObject::execute()
{
...
void
Transformed111GlobalBFOMaterialRVEUserObject::threadJoin(const UserObject & uo)
{
  const Transformed111GlobalBFOMaterialRVEUserObject & pstuo = static_cast<const Transformed111GlobalBFOMaterialRVEUserObject &>(uo);
  _residual += pstuo._residual;
  _jacobian += pstuo._jacobian;
}

void
Transformed111GlobalBFOMaterialRVEUserObject::finalize()
{
...
const RankTwoTensor &
Transformed111GlobalBFOMaterialRVEUserObject::getResidual() const
{
  return _residual;
}

const RankFourTensor &
Transformed111GlobalBFOMaterialRVEUserObject::getJacobian() const
{
  return _jacobian;
}

const VectorValue<bool> &
Transformed111GlobalBFOMaterialRVEUserObject::getPeriodicDirections() const
{
