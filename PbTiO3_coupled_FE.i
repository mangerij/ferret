...
[BCs]
  ...
  #Sides {5, 6, 7, 8}:
  #[./disp_x_slab5] #by fixing the ends, we induce a strain gradient across the material.
  #  type = DirichletBC
  #  variable = disp_x
  #  boundary = '5'
  #  value = 0.0
...
[Materials]
  ...
  ## NOTE: that most epitaxial conditions: strain gradient from the interface)
...
[Preconditioning]
  ...
  #  #off_diag_row    = 'polar_x polar_y polar_z potential_int potential_ext' #can't use due to BlockRestrictable
  #  #off_diag_column = 'disp_x disp_y disp_z'
  #  #solve_type = 'NEWTON' #note that PJFNK and NEWTON do not work for this...? but this gives GREAT linear convergence
  #  petsc_options = '-snes_view -snes_linesearch_monitor -snes_converged_reason -ksp_converged_reason -options_left'
  #  petsc_options_iname = '-snes_type -ksp_gmres_restart -snes_rtol -ksp_rtol -pc_type -pc_factor_zeropivot -pc_side   '
  #  petsc_options_value = '  newtonls   1500              1e-8      1e-8        bjacobi       1e-50             left    '
  #[../]
  [./smp]
    type = SMP
    full = true
    ...
    petsc_options_value = '   1500              1e-8      1e-10     hypre       1e-50             left    '
  [../]
[]
...
#    petsc_options_value='    gmres            350              1e-12   lu       asm        2                         1e-50                1e-50  '
#  [../]
#  [./elastic]
...
#    petsc_options_value = ' gmres       350                lu         1e-12    asm          2           1e-50                        1e-50 '
#  [../]
#[]
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_PbTiO3_60nm_T650_compress_FE_para
    output_initial = true
