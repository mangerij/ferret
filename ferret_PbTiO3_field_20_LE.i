...
#NOTE: First time step calculates the depolarization field due to the unphysical initial condition. Energy may increase, which is allowed.
  ...
  petsc_options_iname='-ksp_type  -pc_type -pc_factor_zeropivot -snes_rtol -ksp_rtol' 
  petsc_options_value='gmres        lu                1e-50       1e-10       1e-15' 
...
print_perf_log = true
  ...
  [./out]
    type = Exodus
    file_base = out_PbTiO3_bulk_len-9_icConst111_n3500_0field_1wall_restart_LU_tight
    output_initial = true
