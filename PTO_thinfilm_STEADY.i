...
[Preconditioning]
  [./smp]
    ...
    petsc_options_value = '    1250             1e-6      1e-8   pbjacobi'
  [../]
[]
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = outPTO_thinfilm_testSTEADY
    elemental_as_nodal = true
  [../]
[]

#converges without pc_hypre_boomeramg_max_iter shows stripes but not entirely exciting... but time dependence removed!?!!?!?!?!?

#symmetric-SOR/Jacobi is best relax up/down so far. Tried sequential-Gauss-Seidel

# set 1e-4 1e-5 (or maybe looser with 1e-3 IC on P and you get c-domains... with HYPRE boomeramg and 1.0 strong treshhold) what about other PC?

#eisenstat PC is nice... -snes_ksp_ew isnt that good but we can crank rtol for eisenstat pc... WHO IS THIS PERSON?

#to tweak -snes_ksp_ew we can use rtol0 ? it doesnt work well..

#pc type eisenstat seems best... Is eisenstat good for TDLGD? What about pbjacobi for TDLGD? pbjacobi is best.. can drive down

#pbjacobi is a point block (takes diagonals of the blocks) and then uses for pc. Anyway, doesnt seem the best at driving nonlinear iterations down (IF initial condition is random)
