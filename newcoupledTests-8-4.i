...
[GlobalParams]
len_scale = 1
alpha1 = -0.0282827 # (3.766(T-765.1)*10^5) C^{-2} nm^2 (T = 673 K)
alpha11 = -0.07253
alpha111 = 0.26
alpha12 = 0.75
alpha112 = 0.61
...
[Preconditioning]
  [./smp]
    ...
    petsc_options_value = '    501             1e-8   1e-16      bjacobi          1e-50          left        '
  [../]
[]
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_PbTiO3_50nm_scale-cnorm_T-8_strain-4
    output_initial = true
