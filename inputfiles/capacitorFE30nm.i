...
[Preconditioning]
  [./smp]
    ...
    petsc_options_value = '    121            1e-8	 1e-11      gamg        7   ilu          1e-50    1e-50	  left        '
  [../]
[]
...
[Executioner]
  ...
  [./TimeStepper] #iterative DT halfs the time it takes to find a solution? oh well, our time is fake in this simulation anyway...
    ...
    dt = 0.3 #max seems to be about 1.0 but could depend on refinement...
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_PTOSTOcomposite_test2
    output_initial = true
