...
[Preconditioning]
  [./smp]
    type = SMP
    full = true
    petsc_options = '-snes_view -snes_linesearch_monitor -snes_converged_reason -snes_ksp_ew -ksp_converged_reason -options_left'
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_PbTiO3_slab_002_ew
    output_initial = true
