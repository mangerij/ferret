...
solUnstrAll[j_, k_] := ParallelTable[Table[Table[NSolve[{
       D[fitUniversal[T, Px, Py, 0, Ex, Ey], Px] == 0,
       D[fitUniversal[T, Px, Py, 0, Ex, Ey], Py],
       Px < 1,
       Py < 1,
       Px >= 0,
       Py >= 0},
...
Do[
 a = solUnstrAll[n + 1, n];
 Export["/home/john/projects/solUnstr-" <> ToString[n] <> ".csv", a,
   "CSV"], {n, 1, 400, 1}
 ]
