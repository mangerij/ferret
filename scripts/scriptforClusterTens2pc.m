...
solTens2pcAll[j_, k_] := ParallelTable[Table[Table[NSolve[{
       D[fitUniversal[T, Px, Py, 0.02, Ex, Ey], Px] == 0,
       D[fitUniversal[T, Px, Py, 0.02, Ex, Ey], Py],
       Px < 1,
       Py < 1,
       Px >= 0,
       Py >= 0},
...
Do[
 a = solTens2pcAll[n + 1, n];
 Export["/home/john/projects/solTens2pc-" <> ToString[n] <> ".csv", a,
   "CSV"], {n, 1, 400, 1}
 ]
