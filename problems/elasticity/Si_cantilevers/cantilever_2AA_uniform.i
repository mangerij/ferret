...
[BCs]
  ...
  # active = 'anchor3_X anchor3_Y anchor3_Z anchor2_Y anchor4_Y anchor5_Y anchor5_Z'
  ...
  #  Cantilever side with the (0,-1,0) normal; no side twists: 
...
[Output]
#  file_base = out_cantilever_2AA_uniform_meshref1
  file_base = out_cantilever_2AA_uniform_asm
  interval = 1
  output_initial = true
