# This is an example for a box with 6 grains

[Mesh]
  file = ferret_6grain_example_Tetmesh2.e
  uniform_refine = 1
...
[Output]
#  file_base = out_grain6_example_uniax_TM
  file_base = out_grain6_example_uniax_TM_mesh_ref1
  interval = 1
  output_initial = true
