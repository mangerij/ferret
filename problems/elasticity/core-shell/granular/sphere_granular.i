...
[Mesh]#Comment
  file = ../../../../mesh/sphere_id7_od13_meshed_v2.e
#  uniform_refine = 1
...
# isotropic bulk modulus=1.5, shear modulus=1.5
    C_ijkl='260.5e-09 148.3e-09 148.3e-09 260.5e-09 148.3e-09 260.5e-09 63.3e-09 63.3e-09 63.3e-09'
...
#  type = Transient
  petsc_options = '-snes_monitor -snes_converged_reason -ksp_monitor -ksp_view -ksp_converged_reason'
  petsc_options_iname = '-ksp_type -pc_type -pc_asm_overlap -ksp_max_it -snes_max_it'
  petsc_options_value = '    gmres     asm  16              100        5'
#  petsc_options_iname = '-ksp_type -pc_type '
