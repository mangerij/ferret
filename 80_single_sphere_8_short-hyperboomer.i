...
[Preconditioning]
  [./smp]
    ...
    petsc_options_iname = '-ksp_gmres_restart -snes_rtol -ksp_rtol -pc_type -pc_hypre_type    -sub_pc_factor_zeropivot -pc_factor_zeropivot -pc_side '
    petsc_options_value = '    121            1e-9	 1e-14      hypre       boomeramg       1e-50    1e-50	  left        '
  [../]
[]
...
[Executioner]
  ...
  [./TimeStepper] #iterative DT halfs the time it takes to find a solution? oh well, our time is fake in this simulation anyway...
    ...
    dt = 0.45 #max seems to be about 1.0 but could depend on refinement...
    #there is also a cutback on this for 0.2*optimal and yes i think it does count the 0th one.
    #iteration_window = 10
    optimal_iterations = 2 #i think this is 3 or more then cut? less than 3 grow, does it count the 0th iteration? no the cutting has to do with the iteration ratio
    growth_factor = 1.4
    linear_iteration_ratio = 1000
    #linear_iteration_ratio = 1000
    cutback_factor =  0.995
  [../]
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_PTOSTOcomposite_single8hypre
#    output_initial = true
