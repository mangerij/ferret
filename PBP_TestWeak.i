...
[Executioner]
  ...
  petsc_options_iname = '-snes_rtol -ksp_rtol -pc_type -pc_boomeramg_strong_threshold -sub_pc_type -pc_asm_overlap -sub_pc_factor_zeropivot -pc_factor_zeropivot'
  petsc_options_value = '  1e-10       1e-14     hypre       0.5                        ilu            2               1e-50                    1e-50'
[]
#[Splits]
#  [./ferretsplit]
#    type = Split
...
#    petsc_options_value=' gmres            350              1e-14     ilu         ilu         5                         1e-50                1e-50  '
#  [../]
#  [./elastic]
...
#    petsc_options_value = 'gmres       350                 ilu         1e-14     ilu         5           1e-50                        1e-50'
#  [../]
#[]
[Outputs]
